...
inline int dotProductSign2D_filtered(double px, double py, double rx, double ry,
                                     double qx, double qy) {
...
inline int dotProductSign2D_interval(interval_number px, interval_number py,
                                     interval_number rx, interval_number ry,
                                     interval_number qx, interval_number qy) {
  setFPUModeToRoundUP();
...
inline int dotProductSign2D_bigfloat(bigfloat px, bigfloat py, bigfloat rx,
                                     bigfloat ry, bigfloat qx, bigfloat qy) {
...
inline int dotProductSign2D_exact(double px, double py, double rx, double ry,
                                  double qx, double qy) {
...
inline int dotProductSign2D(double px, double py, double rx, double ry,
                            double qx, double qy) {
  int ret;
...
inline int dotProductSign3D_filtered(double px, double py, double pz, double rx,
...
inline int dotProductSign3D_interval(interval_number px, interval_number py,
                                     interval_number pz, interval_number rx,
                                     interval_number ry, interval_number rz,
                                     interval_number qx, interval_number qy,
                                     interval_number qz) {
  setFPUModeToRoundUP();
  const interval_number lx(px - qx);
...
inline int dotProductSign3D_bigfloat(bigfloat px, bigfloat py, bigfloat pz,
...
inline int dotProductSign3D_exact(double px, double py, double pz, double rx,
                                  double ry, double rz, double qx, double qy,
                                  double qz) {
...
inline int dotProductSign3D(double px, double py, double pz, double rx,
                            double ry, double rz, double qx, double qy,
                            double qz) {
  int ret;
...
inline int incircle_exact(double pax, double pay, double pbx, double pby,
  ...
  double abdet[16];
  int abdet_len =
      expansionObject::Gen_Diff(abdeta_len, abdeta, abdetb_len, abdetb, abdet);
  double bcdeta[8];
  ...
  double bcdet[16];
  int bcdet_len =
      expansionObject::Gen_Diff(bcdeta_len, bcdeta, bcdetb_len, bcdetb, bcdet);
  double cadeta[8];
  ...
  double cadet[16];
  int cadet_len =
      expansionObject::Gen_Diff(cadeta_len, cadeta, cadetb_len, cadetb, cadet);
  double alifta[8];
  ...
  double alift[16];
  int alift_len =
      expansionObject::Gen_Sum(alifta_len, alifta, aliftb_len, aliftb, alift);
  double blifta[8];
  ...
  double blift[16];
  int blift_len =
      expansionObject::Gen_Sum(blifta_len, blifta, bliftb_len, bliftb, blift);
  double clifta[8];
  ...
  double clift[16];
  int clift_len =
      expansionObject::Gen_Sum(clifta_len, clifta, cliftb_len, cliftb, clift);
  double la_p[128], *la = la_p;
  int la_len = expansionObject::Gen_Product_With_PreAlloc(
      alift_len, alift, bcdet_len, bcdet, &la, 128);
  double lb_p[128], *lb = lb_p;
  int lb_len = expansionObject::Gen_Product_With_PreAlloc(
      blift_len, blift, cadet_len, cadet, &lb, 128);
  double lc_p[128], *lc = lc_p;
  int lc_len = expansionObject::Gen_Product_With_PreAlloc(
      clift_len, clift, abdet_len, abdet, &lc, 128);
  double lab_p[128], *lab = lab_p;
  int lab_len =
      expansionObject::Gen_Sum_With_PreAlloc(la_len, la, lb_len, lb, &lab, 128);
  double L_p[128], *L = L_p;
  int L_len =
      expansionObject::Gen_Sum_With_PreAlloc(lab_len, lab, lc_len, lc, &L, 128);
...
inline int inSphere_exact(double pax, double pay, double paz, double pbx,
  ...
  double ab[16];
  int ab_len =
      expansionObject::Gen_Diff(aexbey_len, aexbey, bexaey_len, bexaey, ab);
  double bexcey[8];
  ...
  double bc[16];
  int bc_len =
      expansionObject::Gen_Diff(bexcey_len, bexcey, cexbey_len, cexbey, bc);
  double cexdey[8];
  ...
  double cd[16];
  int cd_len =
      expansionObject::Gen_Diff(cexdey_len, cexdey, dexcey_len, dexcey, cd);
  double dexaey[8];
  ...
  double da[16];
  int da_len =
      expansionObject::Gen_Diff(dexaey_len, dexaey, aexdey_len, aexdey, da);
  double aexcey[8];
  ...
  double ac[16];
  int ac_len =
      expansionObject::Gen_Diff(aexcey_len, aexcey, cexaey_len, cexaey, ac);
  double bexdey[8];
  ...
  double bd[16];
  int bd_len =
      expansionObject::Gen_Diff(bexdey_len, bexdey, dexbey_len, dexbey, bd);
  double abc1_p[32], *abc1 = abc1_p;
  int abc1_len =
      expansionObject::Gen_Product_With_PreAlloc(2, aez, bc_len, bc, &abc1, 32);
  double abc2_p[32], *abc2 = abc2_p;
  int abc2_len =
      expansionObject::Gen_Product_With_PreAlloc(2, bez, ac_len, ac, &abc2, 32);
  double abc3_p[32], *abc3 = abc3_p;
  int abc3_len =
      expansionObject::Gen_Product_With_PreAlloc(2, cez, ab_len, ab, &abc3, 32);
  double abc4_p[32], *abc4 = abc4_p;
  int abc4_len = expansionObject::Gen_Sum_With_PreAlloc(
      abc1_len, abc1, abc3_len, abc3, &abc4, 32);
  double abc_p[32], *abc = abc_p;
  int abc_len = expansionObject::Gen_Diff_With_PreAlloc(
      abc4_len, abc4, abc2_len, abc2, &abc, 32);
  double bcd1_p[32], *bcd1 = bcd1_p;
  int bcd1_len =
      expansionObject::Gen_Product_With_PreAlloc(2, bez, cd_len, cd, &bcd1, 32);
  double bcd2_p[32], *bcd2 = bcd2_p;
  int bcd2_len =
      expansionObject::Gen_Product_With_PreAlloc(2, cez, bd_len, bd, &bcd2, 32);
  double bcd3_p[32], *bcd3 = bcd3_p;
  int bcd3_len =
      expansionObject::Gen_Product_With_PreAlloc(2, dez, bc_len, bc, &bcd3, 32);
  double bcd4_p[32], *bcd4 = bcd4_p;
  int bcd4_len = expansionObject::Gen_Sum_With_PreAlloc(
      bcd1_len, bcd1, bcd3_len, bcd3, &bcd4, 32);
  double bcd_p[32], *bcd = bcd_p;
  int bcd_len = expansionObject::Gen_Diff_With_PreAlloc(
      bcd4_len, bcd4, bcd2_len, bcd2, &bcd, 32);
  double cda1_p[32], *cda1 = cda1_p;
  int cda1_len =
      expansionObject::Gen_Product_With_PreAlloc(2, cez, da_len, da, &cda1, 32);
  double cda2_p[32], *cda2 = cda2_p;
  int cda2_len =
      expansionObject::Gen_Product_With_PreAlloc(2, dez, ac_len, ac, &cda2, 32);
  double cda3_p[32], *cda3 = cda3_p;
  int cda3_len =
      expansionObject::Gen_Product_With_PreAlloc(2, aez, cd_len, cd, &cda3, 32);
  double cda4_p[32], *cda4 = cda4_p;
  int cda4_len = expansionObject::Gen_Sum_With_PreAlloc(
      cda1_len, cda1, cda3_len, cda3, &cda4, 32);
  double cda_p[32], *cda = cda_p;
  int cda_len = expansionObject::Gen_Sum_With_PreAlloc(cda4_len, cda4, cda2_len,
                                                       cda2, &cda, 32);
  double dab1_p[32], *dab1 = dab1_p;
  int dab1_len =
      expansionObject::Gen_Product_With_PreAlloc(2, dez, ab_len, ab, &dab1, 32);
  double dab2_p[32], *dab2 = dab2_p;
  int dab2_len =
      expansionObject::Gen_Product_With_PreAlloc(2, aez, bd_len, bd, &dab2, 32);
  double dab3_p[32], *dab3 = dab3_p;
  int dab3_len =
      expansionObject::Gen_Product_With_PreAlloc(2, bez, da_len, da, &dab3, 32);
  double dab4_p[32], *dab4 = dab4_p;
  int dab4_len = expansionObject::Gen_Sum_With_PreAlloc(
      dab1_len, dab1, dab3_len, dab3, &dab4, 32);
  double dab_p[32], *dab = dab_p;
  int dab_len = expansionObject::Gen_Sum_With_PreAlloc(dab4_len, dab4, dab2_len,
                                                       dab2, &dab, 32);
  double al1[8];
  ...
  int ds1_len = expansionObject::Gen_Product_With_PreAlloc(
      dlift_len, dlift, abc_len, abc, &ds1, 32);
  double ds2_p[32], *ds2 = ds2_p;
  int ds2_len = expansionObject::Gen_Product_With_PreAlloc(
      clift_len, clift, dab_len, dab, &ds2, 32);
  double dl_p[32], *dl = dl_p;
  int dl_len = expansionObject::Gen_Diff_With_PreAlloc(ds2_len, ds2, ds1_len,
                                                       ds1, &dl, 32);
  double dr1_p[32], *dr1 = dr1_p;
  int dr1_len = expansionObject::Gen_Product_With_PreAlloc(
      blift_len, blift, cda_len, cda, &dr1, 32);
  double dr2_p[32], *dr2 = dr2_p;
  int dr2_len = expansionObject::Gen_Product_With_PreAlloc(
      alift_len, alift, bcd_len, bcd, &dr2, 32);
  double dr_p[32], *dr = dr_p;
  int dr_len = expansionObject::Gen_Diff_With_PreAlloc(dr2_len, dr2, dr1_len,
                                                       dr1, &dr, 32);
  double det_p[32], *det = det_p;
  int det_len =
      expansionObject::Gen_Sum_With_PreAlloc(dl_len, dl, dr_len, dr, &det, 32);
...
inline int dotProductSign2D_EEI_interval(const genericPoint &q,
                                         interval_number px, interval_number py,
                                         interval_number rx,
                                         interval_number ry) {
...
inline int dotProductSign2D_EEI_bigfloat(const genericPoint &q, bigfloat px,
                                         bigfloat py, bigfloat rx,
                                         bigfloat ry) {
  bigfloat lqx, lqy, dq;
...
inline int dotProductSign2D_EEI_exact(const genericPoint &q, double px,
  ...
  if ((dq[dq_len - 1] != 0)) {
    ...
    int pxq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, px, &pxq, 128);
    double pyq_p[128], *pyq = pyq_p;
    int pyq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, py, &pyq, 128);
    double rxq_p[128], *rxq = rxq_p;
    int rxq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, rx, &rxq, 128);
    double ryq_p[128], *ryq = ryq_p;
    int ryq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, ry, &ryq, 128);
    double lx_p[128], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(pxq_len, pxq, lqx_len,
                                                         lqx, &lx, 128);
    double ly_p[128], *ly = ly_p;
    int ly_len = expansionObject::Gen_Diff_With_PreAlloc(pyq_len, pyq, lqy_len,
                                                         lqy, &ly, 128);
    double gx_p[128], *gx = gx_p;
    int gx_len = expansionObject::Gen_Diff_With_PreAlloc(rxq_len, rxq, lqx_len,
                                                         lqx, &gx, 128);
    double gy_p[128], *gy = gy_p;
    int gy_len = expansionObject::Gen_Diff_With_PreAlloc(ryq_len, ryq, lqy_len,
                                                         lqy, &gy, 128);
    double dx_p[128], *dx = dx_p;
    int dx_len = expansionObject::Gen_Product_With_PreAlloc(lx_len, lx, gx_len,
                                                            gx, &dx, 128);
    double dy_p[128], *dy = dy_p;
    int dy_len = expansionObject::Gen_Product_With_PreAlloc(ly_len, ly, gy_len,
                                                            gy, &dy, 128);
    double d_p[128], *d = d_p;
    int d_len =
        expansionObject::Gen_Sum_With_PreAlloc(dx_len, dx, dy_len, dy, &d, 128);
  ...
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign2D_EEI_bigfloat(q, px, py, rx, ry);
#endif
...
inline int dotProductSign2D_EEI(const genericPoint &q, double px, double py,
                                double rx, double ry) {
  int ret;
...
inline int dotProductSign2D_IEE_bigfloat(const genericPoint &p, bigfloat rx,
                                         bigfloat ry, bigfloat qx,
                                         bigfloat qy) {
  bigfloat lpx, lpy, dp;
...
inline int dotProductSign2D_IEE_exact(const genericPoint &p, double rx,
  ...
  if ((dp[dp_len - 1] != 0)) {
    ...
    int qxd_len =
        expansionObject::Gen_Scale_With_PreAlloc(dp_len, dp, qx, &qxd, 128);
    double qyd_p[128], *qyd = qyd_p;
    int qyd_len =
        expansionObject::Gen_Scale_With_PreAlloc(dp_len, dp, qy, &qyd, 128);
    double lx_p[128], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(lpx_len, lpx, qxd_len,
                                                         qxd, &lx, 128);
    double ly_p[128], *ly = ly_p;
    int ly_len = expansionObject::Gen_Diff_With_PreAlloc(lpy_len, lpy, qyd_len,
                                                         qyd, &ly, 128);
    double gx[2];
    expansionObject::two_Diff(rx, qx, gx);
    double gy[2];
    ...
    double dx_p[128], *dx = dx_p;
    int dx_len =
        expansionObject::Gen_Product_With_PreAlloc(lx_len, lx, 2, gx, &dx, 128);
    double dy_p[128], *dy = dy_p;
    int dy_len =
        expansionObject::Gen_Product_With_PreAlloc(ly_len, ly, 2, gy, &dy, 128);
    double d_p[128], *d = d_p;
    int d_len =
        expansionObject::Gen_Sum_With_PreAlloc(dx_len, dx, dy_len, dy, &d, 128);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign2D_IEE_bigfloat(p, rx, ry, qx, qy);
#endif
...
inline int dotProductSign2D_IEE(const genericPoint &p, double rx, double ry,
                                double qx, double qy) {
  int ret;
...
inline int dotProductSign2D_IEI_interval(const genericPoint &p,
...
inline int dotProductSign2D_IEI_bigfloat(const genericPoint &p,
                                         const genericPoint &q, bigfloat rx,
                                         bigfloat ry) {
...
inline int dotProductSign2D_IEI_exact(const genericPoint &p,
                                      const genericPoint &q, double rx,
                                      double ry) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
  ...
  if ((dp[dp_len - 1] != 0) && (dq[dq_len - 1] != 0)) {
    ...
    int dqp_len = expansionObject::Gen_Product_With_PreAlloc(dq_len, dq, dp_len,
                                                             dp, &dqp, 64);
    double pxq_p[64], *pxq = pxq_p;
    int pxq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpx_len, lpx, dqp_len, dqp, &pxq, 64);
    double pyq_p[64], *pyq = pyq_p;
    int pyq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpy_len, lpy, dqp_len, dqp, &pyq, 64);
    double rxq_p[64], *rxq = rxq_p;
    int rxq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, rx, &rxq, 64);
    double ryq_p[64], *ryq = ryq_p;
    int ryq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, ry, &ryq, 64);
    double lqxd_p[64], *lqxd = lqxd_p;
    int lqxd_len = expansionObject::Gen_Product_With_PreAlloc(
        lqx_len, lqx, dp_len, dp, &lqxd, 64);
    double lqyd_p[64], *lqyd = lqyd_p;
    int lqyd_len = expansionObject::Gen_Product_With_PreAlloc(
        lqy_len, lqy, dp_len, dp, &lqyd, 64);
    double lx_p[64], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(pxq_len, pxq, lqxd_len,
                                                         lqxd, &lx, 64);
    double ly_p[64], *ly = ly_p;
    int ly_len = expansionObject::Gen_Diff_With_PreAlloc(pyq_len, pyq, lqyd_len,
                                                         lqyd, &ly, 64);
    ...
    double d_p[64], *d = d_p;
    int d_len =
        expansionObject::Gen_Sum_With_PreAlloc(dx_len, dx, dy_len, dy, &d, 64);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign2D_IEI_bigfloat(p, q, rx, ry);
#endif
...
inline int dotProductSign2D_IEI(const genericPoint &p, const genericPoint &q,
                                double rx, double ry) {
  int ret;
...
inline int dotProductSign2D_IIE_interval(const genericPoint &p,
...
inline int dotProductSign2D_IIE_bigfloat(const genericPoint &p,
                                         const genericPoint &r, bigfloat qx,
                                         bigfloat qy) {
...
inline int dotProductSign2D_IIE_exact(const genericPoint &p,
                                      const genericPoint &r, double qx,
                                      double qy) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
  ...
  if ((dp[dp_len - 1] != 0) && (dr[dr_len - 1] != 0)) {
    ...
    int qxd_len =
        expansionObject::Gen_Scale_With_PreAlloc(dp_len, dp, qx, &qxd, 64);
    double qyd_p[64], *qyd = qyd_p;
    int qyd_len =
        expansionObject::Gen_Scale_With_PreAlloc(dp_len, dp, qy, &qyd, 64);
    double lx_p[64], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(lpx_len, lpx, qxd_len,
                                                         qxd, &lx, 64);
    double ly_p[64], *ly = ly_p;
    ...
    int qxr_len =
        expansionObject::Gen_Scale_With_PreAlloc(dr_len, dr, qx, &qxr, 64);
    double qyr_p[64], *qyr = qyr_p;
    int qyr_len =
        expansionObject::Gen_Scale_With_PreAlloc(dr_len, dr, qy, &qyr, 64);
    double gx_p[64], *gx = gx_p;
    int gx_len = expansionObject::Gen_Diff_With_PreAlloc(lrx_len, lrx, qxr_len,
                                                         qxr, &gx, 64);
    double gy_p[64], *gy = gy_p;
    int gy_len = expansionObject::Gen_Diff_With_PreAlloc(lry_len, lry, qyr_len,
                                                         qyr, &gy, 64);
    double dx_p[64], *dx = dx_p;
    int dx_len = expansionObject::Gen_Product_With_PreAlloc(lx_len, lx, gx_len,
                                                            gx, &dx, 64);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign2D_IIE_bigfloat(p, r, qx, qy);
#endif
...
inline int dotProductSign2D_IIE(const genericPoint &p, const genericPoint &r,
                                double qx, double qy) {
  int ret;
...
inline int dotProductSign2D_III_interval(const genericPoint &p,
                                         const genericPoint &r,
                                         const genericPoint &q) {
...
inline int dotProductSign2D_III_bigfloat(const genericPoint &p,
                                         const genericPoint &r,
                                         const genericPoint &q) {
...
inline int dotProductSign2D_III_exact(const genericPoint &p,
                                      const genericPoint &r,
                                      const genericPoint &q) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  ...
  if ((dp[dp_len - 1] != 0) && (dr[dr_len - 1] != 0) && (dq[dq_len - 1] != 0)) {
    ...
    double qxd_p[64], *qxd = qxd_p;
    int qxd_len = expansionObject::Gen_Product_With_PreAlloc(
        lqx_len, lqx, dp_len, dp, &qxd, 64);
    double qyd_p[64], *qyd = qyd_p;
    int qyd_len = expansionObject::Gen_Product_With_PreAlloc(
        lqy_len, lqy, dp_len, dp, &qyd, 64);
    double lpxq_p[64], *lpxq = lpxq_p;
    int lpxq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpx_len, lpx, dq_len, dq, &lpxq, 64);
    double lpyq_p[64], *lpyq = lpyq_p;
    int lpyq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpy_len, lpy, dq_len, dq, &lpyq, 64);
    double lx_p[64], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(lpxq_len, lpxq,
                                                         qxd_len, qxd, &lx, 64);
    double ly_p[64], *ly = ly_p;
    int ly_len = expansionObject::Gen_Diff_With_PreAlloc(lpyq_len, lpyq,
                                                         qyd_len, qyd, &ly, 64);
    double qxr_p[64], *qxr = qxr_p;
    int qxr_len = expansionObject::Gen_Product_With_PreAlloc(
        lqx_len, lqx, dr_len, dr, &qxr, 64);
    double qyr_p[64], *qyr = qyr_p;
    int qyr_len = expansionObject::Gen_Product_With_PreAlloc(
        lqy_len, lqy, dr_len, dr, &qyr, 64);
    double lrxq_p[64], *lrxq = lrxq_p;
    int lrxq_len = expansionObject::Gen_Product_With_PreAlloc(
        lrx_len, lrx, dq_len, dq, &lrxq, 64);
    double lryq_p[64], *lryq = lryq_p;
    int lryq_len = expansionObject::Gen_Product_With_PreAlloc(
        lry_len, lry, dq_len, dq, &lryq, 64);
    double gx_p[64], *gx = gx_p;
    int gx_len = expansionObject::Gen_Diff_With_PreAlloc(lrxq_len, lrxq,
                                                         qxr_len, qxr, &gx, 64);
    double gy_p[64], *gy = gy_p;
    int gy_len = expansionObject::Gen_Diff_With_PreAlloc(lryq_len, lryq,
                                                         qyr_len, qyr, &gy, 64);
    double dx_p[64], *dx = dx_p;
    int dx_len = expansionObject::Gen_Product_With_PreAlloc(lx_len, lx, gx_len,
                                                            gx, &dx, 64);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign2D_III_bigfloat(p, r, q);
#endif
...
inline int dotProductSign2D_III(const genericPoint &p, const genericPoint &r,
                                const genericPoint &q) {
  int ret;
...
inline int dotProductSign3D_EEI_bigfloat(const genericPoint &q, bigfloat px,
                                         bigfloat py, bigfloat pz, bigfloat rx,
                                         bigfloat ry, bigfloat rz) {
...
inline int dotProductSign3D_EEI_exact(const genericPoint &q, double px,
                                      double py, double pz, double rx,
                                      double ry, double rz) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
  ...
  if ((dq[dq_len - 1] != 0)) {
    ...
    double pxq_p[64], *pxq = pxq_p;
    int pxq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, px, &pxq, 64);
    double pyq_p[64], *pyq = pyq_p;
    int pyq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, py, &pyq, 64);
    double pzq_p[64], *pzq = pzq_p;
    int pzq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, pz, &pzq, 64);
    double rxq_p[64], *rxq = rxq_p;
    int rxq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, rx, &rxq, 64);
    double ryq_p[64], *ryq = ryq_p;
    ...
    int rzq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, rz, &rzq, 64);
    double lx_p[64], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(pxq_len, pxq, lqx_len,
                                                         lqx, &lx, 64);
    double ly_p[64], *ly = ly_p;
    ...
    int lz_len = expansionObject::Gen_Diff_With_PreAlloc(pzq_len, pzq, lqz_len,
                                                         lqz, &lz, 64);
    double gx_p[64], *gx = gx_p;
    int gx_len = expansionObject::Gen_Diff_With_PreAlloc(rxq_len, rxq, lqx_len,
                                                         lqx, &gx, 64);
    ...
    int gz_len = expansionObject::Gen_Diff_With_PreAlloc(rzq_len, rzq, lqz_len,
                                                         lqz, &gz, 64);
    double dx_p[64], *dx = dx_p;
    int dx_len = expansionObject::Gen_Product_With_PreAlloc(lx_len, lx, gx_len,
                                                            gx, &dx, 64);
    ...
    int dz_len = expansionObject::Gen_Product_With_PreAlloc(lz_len, lz, gz_len,
                                                            gz, &dz, 64);
    double d1_p[64], *d1 = d1_p;
    int d1_len =
        expansionObject::Gen_Sum_With_PreAlloc(dx_len, dx, dy_len, dy, &d1, 64);
    double d_p[64], *d = d_p;
    int d_len =
        expansionObject::Gen_Sum_With_PreAlloc(d1_len, d1, dz_len, dz, &d, 64);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign3D_EEI_bigfloat(q, px, py, pz, rx, ry, rz);
#endif
...
inline int dotProductSign3D_EEI(const genericPoint &q, double px, double py,
...
inline int dotProductSign3D_IEE_interval(const genericPoint &p,
                                         interval_number rx, interval_number ry,
                                         interval_number rz, interval_number qx,
                                         interval_number qy,
                                         interval_number qz) {
...
inline int dotProductSign3D_IEE_bigfloat(const genericPoint &p, bigfloat rx,
                                         bigfloat ry, bigfloat rz, bigfloat qx,
                                         bigfloat qy, bigfloat qz) {
...
inline int dotProductSign3D_IEE_exact(const genericPoint &p, double rx,
                                      double ry, double rz, double qx,
                                      double qy, double qz) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  feclearexcept(FE_ALL_EXCEPT);
  ...
  if ((dp[dp_len - 1] != 0)) {
    ...
    int qzd_len =
        expansionObject::Gen_Scale_With_PreAlloc(dp_len, dp, qz, &qzd, 128);
    double lx_p[128], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(lpx_len, lpx, qxd_len,
                                                         qxd, &lx, 128);
    double ly_p[128], *ly = ly_p;
    ...
    int lz_len = expansionObject::Gen_Diff_With_PreAlloc(lpz_len, lpz, qzd_len,
                                                         qzd, &lz, 128);
    double gx[2];
    expansionObject::two_Diff(rx, qx, gx);
    double gy[2];
    ...
    int dz_len =
        expansionObject::Gen_Product_With_PreAlloc(lz_len, lz, 2, gz, &dz, 128);
    double d1_p[128], *d1 = d1_p;
    int d1_len = expansionObject::Gen_Sum_With_PreAlloc(dx_len, dx, dy_len, dy,
                                                        &d1, 128);
    double d_p[128], *d = d_p;
    int d_len =
        expansionObject::Gen_Sum_With_PreAlloc(d1_len, d1, dz_len, dz, &d, 128);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign3D_IEE_bigfloat(p, rx, ry, rz, qx, qy, qz);
#endif
...
inline int dotProductSign3D_IEE(const genericPoint &p, double rx, double ry,
...
inline int dotProductSign3D_IEI_bigfloat(const genericPoint &p,
                                         const genericPoint &q, bigfloat rx,
                                         bigfloat ry, bigfloat rz) {
...
inline int dotProductSign3D_IEI_exact(const genericPoint &p,
                                      const genericPoint &q, double rx,
                                      double ry, double rz) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  ...
  if ((dp[dp_len - 1] != 0) && (dq[dq_len - 1] != 0)) {
    ...
    int pyq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpy_len, lpy, dqp_len, dqp, &pyq, 64);
    double pzq_p[64], *pzq = pzq_p;
    int pzq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpz_len, lpz, dqp_len, dqp, &pzq, 64);
    double rxq_p[64], *rxq = rxq_p;
    int rxq_len =
        expansionObject::Gen_Scale_With_PreAlloc(dq_len, dq, rx, &rxq, 64);
    double ryq_p[64], *ryq = ryq_p;
    ...
    int lqzd_len = expansionObject::Gen_Product_With_PreAlloc(
        lqz_len, lqz, dp_len, dp, &lqzd, 64);
    double lx_p[64], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(pxq_len, pxq, lqxd_len,
                                                         lqxd, &lx, 64);
    double ly_p[64], *ly = ly_p;
    int ly_len = expansionObject::Gen_Diff_With_PreAlloc(pyq_len, pyq, lqyd_len,
                                                         lqyd, &ly, 64);
    double lz_p[64], *lz = lz_p;
    int lz_len = expansionObject::Gen_Diff_With_PreAlloc(pzq_len, pzq, lqzd_len,
                                                         lqzd, &lz, 64);
    double gx_p[64], *gx = gx_p;
    int gx_len = expansionObject::Gen_Diff_With_PreAlloc(rxq_len, rxq, lqx_len,
                                                         lqx, &gx, 64);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign3D_IEI_bigfloat(p, q, rx, ry, rz);
#endif
...
inline int dotProductSign3D_IEI(const genericPoint &p, const genericPoint &q,
...
inline int dotProductSign3D_IIE_bigfloat(const genericPoint &p,
                                         const genericPoint &r, bigfloat qx,
                                         bigfloat qy, bigfloat qz) {
...
inline int dotProductSign3D_IIE_exact(const genericPoint &p,
                                      const genericPoint &r, double qx,
                                      double qy, double qz) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  ...
  if ((dp[dp_len - 1] != 0) && (dr[dr_len - 1] != 0)) {
    ...
    int qzd_len =
        expansionObject::Gen_Scale_With_PreAlloc(dp_len, dp, qz, &qzd, 64);
    double lx_p[64], *lx = lx_p;
    int lx_len = expansionObject::Gen_Diff_With_PreAlloc(lpx_len, lpx, qxd_len,
                                                         qxd, &lx, 64);
    double ly_p[64], *ly = ly_p;
    ...
    int qzr_len =
        expansionObject::Gen_Scale_With_PreAlloc(dr_len, dr, qz, &qzr, 64);
    double gx_p[64], *gx = gx_p;
    int gx_len = expansionObject::Gen_Diff_With_PreAlloc(lrx_len, lrx, qxr_len,
                                                         qxr, &gx, 64);
    double gy_p[64], *gy = gy_p;
    int gy_len = expansionObject::Gen_Diff_With_PreAlloc(lry_len, lry, qyr_len,
                                                         qyr, &gy, 64);
    double gz_p[64], *gz = gz_p;
    int gz_len = expansionObject::Gen_Diff_With_PreAlloc(lrz_len, lrz, qzr_len,
                                                         qzr, &gz, 64);
    double dx_p[64], *dx = dx_p;
    int dx_len = expansionObject::Gen_Product_With_PreAlloc(lx_len, lx, gx_len,
                                                            gx, &dx, 64);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign3D_IIE_bigfloat(p, r, qx, qy, qz);
#endif
...
inline int dotProductSign3D_IIE(const genericPoint &p, const genericPoint &r,
...
inline int dotProductSign3D_III_interval(const genericPoint &p,
                                         const genericPoint &r,
                                         const genericPoint &q) {
...
inline int dotProductSign3D_III_bigfloat(const genericPoint &p,
                                         const genericPoint &r,
                                         const genericPoint &q) {
...
inline int dotProductSign3D_III_exact(const genericPoint &p,
                                      const genericPoint &r,
                                      const genericPoint &q) {
  double return_value = NAN;
#ifdef CHECK_FOR_XYZERFLOWS
  ...
  if ((dp[dp_len - 1] != 0) && (dr[dr_len - 1] != 0) && (dq[dq_len - 1] != 0)) {
    ...
    int qxd_len = expansionObject::Gen_Product_With_PreAlloc(
        lqx_len, lqx, dp_len, dp, &qxd, 32);
    double qyd_p[32], *qyd = qyd_p;
    int qyd_len = expansionObject::Gen_Product_With_PreAlloc(
        lqy_len, lqy, dp_len, dp, &qyd, 32);
    double qzd_p[32], *qzd = qzd_p;
    int qzd_len = expansionObject::Gen_Product_With_PreAlloc(
        lqz_len, lqz, dp_len, dp, &qzd, 32);
    double lpxq_p[32], *lpxq = lpxq_p;
    int lpxq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpx_len, lpx, dq_len, dq, &lpxq, 32);
    double lpyq_p[32], *lpyq = lpyq_p;
    int lpyq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpy_len, lpy, dq_len, dq, &lpyq, 32);
    double lpzq_p[32], *lpzq = lpzq_p;
    int lpzq_len = expansionObject::Gen_Product_With_PreAlloc(
        lpz_len, lpz, dq_len, dq, &lpzq, 32);
    ...
    int lz_len = expansionObject::Gen_Diff_With_PreAlloc(lpzq_len, lpzq,
                                                         qzd_len, qzd, &lz, 32);
    double qxr_p[32], *qxr = qxr_p;
    int qxr_len = expansionObject::Gen_Product_With_PreAlloc(
        lqx_len, lqx, dr_len, dr, &qxr, 32);
    double qyr_p[32], *qyr = qyr_p;
    int qyr_len = expansionObject::Gen_Product_With_PreAlloc(
        lqy_len, lqy, dr_len, dr, &qyr, 32);
    double qzr_p[32], *qzr = qzr_p;
    int qzr_len = expansionObject::Gen_Product_With_PreAlloc(
        lqz_len, lqz, dr_len, dr, &qzr, 32);
    double lrxq_p[32], *lrxq = lrxq_p;
    int lrxq_len = expansionObject::Gen_Product_With_PreAlloc(
        lrx_len, lrx, dq_len, dq, &lrxq, 32);
    double lryq_p[32], *lryq = lryq_p;
    int lryq_len = expansionObject::Gen_Product_With_PreAlloc(
        lry_len, lry, dq_len, dq, &lryq, 32);
    double lrzq_p[32], *lrzq = lrzq_p;
    int lrzq_len = expansionObject::Gen_Product_With_PreAlloc(
        lrz_len, lrz, dq_len, dq, &lrzq, 32);
    ...
    int gz_len = expansionObject::Gen_Diff_With_PreAlloc(lrzq_len, lrzq,
                                                         qzr_len, qzr, &gz, 32);
    ...
    int d1_len =
        expansionObject::Gen_Sum_With_PreAlloc(dx_len, dx, dy_len, dy, &d1, 32);
    double d_p[32], *d = d_p;
    int d_len =
        expansionObject::Gen_Sum_With_PreAlloc(d1_len, d1, dz_len, dz, &d, 32);
...
#ifdef CHECK_FOR_XYZERFLOWS
  if (fetestexcept(FE_UNDERFLOW | FE_OVERFLOW))
    return_value = dotProductSign3D_III_bigfloat(p, r, q);
#endif
...
inline int dotProductSign3D_III(const genericPoint &p, const genericPoint &r,
                                const genericPoint &q) {
  int ret;
...
inline int incirclexy_indirect_IEEE_exact(const genericPoint &p1, double pbx,
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int pdxt_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, pdx, &pdxt, 64);
    double pdyt_p[64], *pdyt = pdyt_p;
    int pdyt_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, pdy, &pdyt, 64);
    double adx_p[64], *adx = adx_p;
    int adx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1x_len, l1x, pdxt_len, pdxt, &adx, 64);
    double ady_p[64], *ady = ady_p;
    int ady_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1y_len, l1y, pdyt_len, pdyt, &ady, 64);
    double bdx[2];
    expansionObject::two_Diff(pbx, pdx, bdx);
    double bdy[2];
    expansionObject::two_Diff(pby, pdy, bdy);
    ...
    int abdeta_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, 2, bdy, &abdeta, 64);
    double abdetb_p[64], *abdetb = abdetb_p;
    int abdetb_len = expansionObject::Gen_Product_With_PreAlloc(
        2, bdx, ady_len, ady, &abdetb, 64);
    double abdet_p[64], *abdet = abdet_p;
    int abdet_len = expansionObject::Gen_Diff_With_PreAlloc(
        abdeta_len, abdeta, abdetb_len, abdetb, &abdet, 64);
    double bcdeta[8];
    int bcdeta_len = expansionObject::Gen_Product(2, bdx, 2, cdy, bcdeta);
    double bcdetb[8];
    int bcdetb_len = expansionObject::Gen_Product(2, cdx, 2, bdy, bcdetb);
    double bcdet[16];
    int bcdet_len = expansionObject::Gen_Diff(bcdeta_len, bcdeta, bcdetb_len,
                                              bcdetb, bcdet);
    double cadeta_p[64], *cadeta = cadeta_p;
    int cadeta_len = expansionObject::Gen_Product_With_PreAlloc(
        2, cdx, ady_len, ady, &cadeta, 64);
    double cadetb_p[64], *cadetb = cadetb_p;
    int cadetb_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, 2, cdy, &cadetb, 64);
    double cadet_p[64], *cadet = cadet_p;
    int cadet_len = expansionObject::Gen_Diff_With_PreAlloc(
        cadeta_len, cadeta, cadetb_len, cadetb, &cadet, 64);
    double alifta_p[64], *alifta = alifta_p;
    int alifta_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, adx_len, adx, &alifta, 64);
    double aliftb_p[64], *aliftb = aliftb_p;
    int aliftb_len = expansionObject::Gen_Product_With_PreAlloc(
        ady_len, ady, ady_len, ady, &aliftb, 64);
    double alift_p[64], *alift = alift_p;
    int alift_len = expansionObject::Gen_Sum_With_PreAlloc(
        alifta_len, alifta, aliftb_len, aliftb, &alift, 64);
    double blifta[8];
    int blifta_len = expansionObject::Gen_Product(2, bdx, 2, bdx, blifta);
    double bliftb[8];
    int bliftb_len = expansionObject::Gen_Product(2, bdy, 2, bdy, bliftb);
    ...
    int la_len = expansionObject::Gen_Product_With_PreAlloc(
        alift_len, alift, bcdet_len, bcdet, &la, 64);
    double lbt_p[64], *lbt = lbt_p;
    int lbt_len = expansionObject::Gen_Product_With_PreAlloc(
        blift_len, blift, cadet_len, cadet, &lbt, 64);
    double lb_p[64], *lb = lb_p;
    int lb_len = expansionObject::Gen_Product_With_PreAlloc(
        lbt_len, lbt, d1_len, d1, &lb, 64);
    double lct_p[64], *lct = lct_p;
    int lct_len = expansionObject::Gen_Product_With_PreAlloc(
        clift_len, clift, abdet_len, abdet, &lct, 64);
    double lc_p[64], *lc = lc_p;
    int lc_len = expansionObject::Gen_Product_With_PreAlloc(
        lct_len, lct, d1_len, d1, &lc, 64);
    double lab_p[64], *lab = lab_p;
    int lab_len = expansionObject::Gen_Sum_With_PreAlloc(la_len, la, lb_len, lb,
                                                         &lab, 64);
    double L_p[64], *L = L_p;
    int L_len = expansionObject::Gen_Sum_With_PreAlloc(lab_len, lab, lc_len, lc,
                                                       &L, 64);
...
inline int incirclexy_indirect_IIEE_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    int pdx1_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, pdx, &pdx1, 32);
    double pdy1_p[32], *pdy1 = pdy1_p;
    int pdy1_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, pdy, &pdy1, 32);
    double adx_p[32], *adx = adx_p;
    int adx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1x_len, l1x, pdx1_len, pdx1, &adx, 32);
    double ady_p[32], *ady = ady_p;
    int ady_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1y_len, l1y, pdy1_len, pdy1, &ady, 32);
    double pdx2_p[32], *pdx2 = pdx2_p;
    int pdx2_len =
        expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, pdx, &pdx2, 32);
    double pdy2_p[32], *pdy2 = pdy2_p;
    int pdy2_len =
        expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, pdy, &pdy2, 32);
    double bdx_p[32], *bdx = bdx_p;
    int bdx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2x_len, l2x, pdx2_len, pdx2, &bdx, 32);
    double bdy_p[32], *bdy = bdy_p;
    int bdy_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2y_len, l2y, pdy2_len, pdy2, &bdy, 32);
    double cdx[2];
    expansionObject::two_Diff(pcx, pdx, cdx);
    double cdy[2];
    expansionObject::two_Diff(pcy, pdy, cdy);
    ...
    int abdeta_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, bdy_len, bdy, &abdeta, 32);
    double abdetb_p[32], *abdetb = abdetb_p;
    int abdetb_len = expansionObject::Gen_Product_With_PreAlloc(
        bdx_len, bdx, ady_len, ady, &abdetb, 32);
    double abdet_p[32], *abdet = abdet_p;
    int abdet_len = expansionObject::Gen_Diff_With_PreAlloc(
        abdeta_len, abdeta, abdetb_len, abdetb, &abdet, 32);
    double bcdeta_p[32], *bcdeta = bcdeta_p;
    int bcdeta_len = expansionObject::Gen_Product_With_PreAlloc(
        bdx_len, bdx, 2, cdy, &bcdeta, 32);
    double bcdetb_p[32], *bcdetb = bcdetb_p;
    int bcdetb_len = expansionObject::Gen_Product_With_PreAlloc(
        2, cdx, bdy_len, bdy, &bcdetb, 32);
    double bcdet_p[32], *bcdet = bcdet_p;
    int bcdet_len = expansionObject::Gen_Diff_With_PreAlloc(
        bcdeta_len, bcdeta, bcdetb_len, bcdetb, &bcdet, 32);
    double cadeta_p[32], *cadeta = cadeta_p;
    int cadeta_len = expansionObject::Gen_Product_With_PreAlloc(
        2, cdx, ady_len, ady, &cadeta, 32);
    double cadetb_p[32], *cadetb = cadetb_p;
    int cadetb_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, 2, cdy, &cadetb, 32);
    double cadet_p[32], *cadet = cadet_p;
    int cadet_len = expansionObject::Gen_Diff_With_PreAlloc(
        cadeta_len, cadeta, cadetb_len, cadetb, &cadet, 32);
    double alifta_p[32], *alifta = alifta_p;
    int alifta_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, adx_len, adx, &alifta, 32);
    double aliftb_p[32], *aliftb = aliftb_p;
    int aliftb_len = expansionObject::Gen_Product_With_PreAlloc(
        ady_len, ady, ady_len, ady, &aliftb, 32);
    double aliftt_p[32], *aliftt = aliftt_p;
    int aliftt_len = expansionObject::Gen_Sum_With_PreAlloc(
        alifta_len, alifta, aliftb_len, aliftb, &aliftt, 32);
    double alift_p[32], *alift = alift_p;
    int alift_len = expansionObject::Gen_Product_With_PreAlloc(
        aliftt_len, aliftt, d2_len, d2, &alift, 32);
    double blifta_p[32], *blifta = blifta_p;
    int blifta_len = expansionObject::Gen_Product_With_PreAlloc(
        bdx_len, bdx, bdx_len, bdx, &blifta, 32);
    double bliftb_p[32], *bliftb = bliftb_p;
    int bliftb_len = expansionObject::Gen_Product_With_PreAlloc(
        bdy_len, bdy, bdy_len, bdy, &bliftb, 32);
    double blift_p[32], *blift = blift_p;
    int blift_len = expansionObject::Gen_Sum_With_PreAlloc(
        blifta_len, blifta, bliftb_len, bliftb, &blift, 32);
    double clifta[8];
    int clifta_len = expansionObject::Gen_Product(2, cdx, 2, cdx, clifta);
    double cliftb[8];
    int cliftb_len = expansionObject::Gen_Product(2, cdy, 2, cdy, cliftb);
    double cliftt[16];
    int cliftt_len = expansionObject::Gen_Sum(clifta_len, clifta, cliftb_len,
                                              cliftb, cliftt);
    double clift_p[32], *clift = clift_p;
    int clift_len = expansionObject::Gen_Product_With_PreAlloc(
        cliftt_len, cliftt, d2_len, d2, &clift, 32);
    double la_p[32], *la = la_p;
    int la_len = expansionObject::Gen_Product_With_PreAlloc(
        alift_len, alift, bcdet_len, bcdet, &la, 32);
    double lb_p[32], *lb = lb_p;
    int lb_len = expansionObject::Gen_Product_With_PreAlloc(
        blift_len, blift, cadet_len, cadet, &lb, 32);
    double lc_p[32], *lc = lc_p;
    int lc_len = expansionObject::Gen_Product_With_PreAlloc(
        clift_len, clift, abdet_len, abdet, &lc, 32);
    double lab_p[32], *lab = lab_p;
    int lab_len = expansionObject::Gen_Sum_With_PreAlloc(lc_len, lc, lb_len, lb,
                                                         &lab, 32);
    double lab2_p[32], *lab2 = lab2_p;
    int lab2_len = expansionObject::Gen_Product_With_PreAlloc(
        lab_len, lab, d1_len, d1, &lab2, 32);
    double L_p[32], *L = L_p;
    int L_len = expansionObject::Gen_Sum_With_PreAlloc(lab2_len, lab2, la_len,
                                                       la, &L, 32);
...
inline int incirclexy_indirect_IIIE_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0)) {
    ...
    int pdx3_len =
        expansionObject::Gen_Scale_With_PreAlloc(d3_len, d3, pdx, &pdx3, 32);
    double pdy3_p[32], *pdy3 = pdy3_p;
    int pdy3_len =
        expansionObject::Gen_Scale_With_PreAlloc(d3_len, d3, pdy, &pdy3, 32);
    double cdx_p[32], *cdx = cdx_p;
    int cdx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3x_len, l3x, pdx3_len, pdx3, &cdx, 32);
    double cdy_p[32], *cdy = cdy_p;
    int cdy_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3y_len, l3y, pdy3_len, pdy3, &cdy, 32);
    double abdeta_p[32], *abdeta = abdeta_p;
    int abdeta_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, bdy_len, bdy, &abdeta, 32);
    double abdetb_p[32], *abdetb = abdetb_p;
    ...
    double bcdeta_p[32], *bcdeta = bcdeta_p;
    int bcdeta_len = expansionObject::Gen_Product_With_PreAlloc(
        bdx_len, bdx, cdy_len, cdy, &bcdeta, 32);
    double bcdetb_p[32], *bcdetb = bcdetb_p;
    int bcdetb_len = expansionObject::Gen_Product_With_PreAlloc(
        cdx_len, cdx, bdy_len, bdy, &bcdetb, 32);
    double bcdet_p[32], *bcdet = bcdet_p;
    int bcdet_len = expansionObject::Gen_Diff_With_PreAlloc(
        bcdeta_len, bcdeta, bcdetb_len, bcdetb, &bcdet, 32);
    double cadeta_p[32], *cadeta = cadeta_p;
    int cadeta_len = expansionObject::Gen_Product_With_PreAlloc(
        cdx_len, cdx, ady_len, ady, &cadeta, 32);
    double cadetb_p[32], *cadetb = cadetb_p;
    int cadetb_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, cdy_len, cdy, &cadetb, 32);
    double cadet_p[32], *cadet = cadet_p;
    int cadet_len = expansionObject::Gen_Diff_With_PreAlloc(
        cadeta_len, cadeta, cadetb_len, cadetb, &cadet, 32);
    double alifta_p[32], *alifta = alifta_p;
    ...
    int alift2_len = expansionObject::Gen_Product_With_PreAlloc(
        aliftt_len, aliftt, d2_len, d2, &alift2, 32);
    double alift_p[32], *alift = alift_p;
    int alift_len = expansionObject::Gen_Product_With_PreAlloc(
        alift2_len, alift2, d3_len, d3, &alift, 32);
    double blifta_p[32], *blifta = blifta_p;
    int blifta_len = expansionObject::Gen_Product_With_PreAlloc(
        bdx_len, bdx, bdx_len, bdx, &blifta, 32);
    double bliftb_p[32], *bliftb = bliftb_p;
    ...
    int bliftt_len = expansionObject::Gen_Sum_With_PreAlloc(
        blifta_len, blifta, bliftb_len, bliftb, &bliftt, 32);
    double blift_p[32], *blift = blift_p;
    int blift_len = expansionObject::Gen_Product_With_PreAlloc(
        bliftt_len, bliftt, d3_len, d3, &blift, 32);
    double clifta_p[32], *clifta = clifta_p;
    int clifta_len = expansionObject::Gen_Product_With_PreAlloc(
        cdx_len, cdx, cdx_len, cdx, &clifta, 32);
    double cliftb_p[32], *cliftb = cliftb_p;
    int cliftb_len = expansionObject::Gen_Product_With_PreAlloc(
        cdy_len, cdy, cdy_len, cdy, &cliftb, 32);
    double cliftt_p[32], *cliftt = cliftt_p;
    int cliftt_len = expansionObject::Gen_Sum_With_PreAlloc(
        clifta_len, clifta, cliftb_len, cliftb, &cliftt, 32);
    double clift_p[32], *clift = clift_p;
    int clift_len = expansionObject::Gen_Product_With_PreAlloc(
        cliftt_len, cliftt, d2_len, d2, &clift, 32);
    double la_p[32], *la = la_p;
    ...
    int lc_len = expansionObject::Gen_Product_With_PreAlloc(
        clift_len, clift, abdet_len, abdet, &lc, 32);
    double lab2_p[32], *lab2 = lab2_p;
    int lab2_len = expansionObject::Gen_Sum_With_PreAlloc(lc_len, lc, lb_len,
                                                          lb, &lab2, 32);
    double lab_p[32], *lab = lab_p;
    int lab_len = expansionObject::Gen_Product_With_PreAlloc(
        lab2_len, lab2, d1_len, d1, &lab, 32);
    double L_p[32], *L = L_p;
    int L_len = expansionObject::Gen_Sum_With_PreAlloc(lab_len, lab, la_len, la,
                                                       &L, 32);
...
inline int incirclexy_indirect_IIII_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0) &&
    ...
    int l1xt_len = expansionObject::Gen_Product_With_PreAlloc(
        l1x_len, l1x, d4_len, d4, &l1xt, 16);
    double l1yt_p[16], *l1yt = l1yt_p;
    int l1yt_len = expansionObject::Gen_Product_With_PreAlloc(
        l1y_len, l1y, d4_len, d4, &l1yt, 16);
    double l2xt_p[16], *l2xt = l2xt_p;
    int l2xt_len = expansionObject::Gen_Product_With_PreAlloc(
        l2x_len, l2x, d4_len, d4, &l2xt, 16);
    double l2yt_p[16], *l2yt = l2yt_p;
    int l2yt_len = expansionObject::Gen_Product_With_PreAlloc(
        l2y_len, l2y, d4_len, d4, &l2yt, 16);
    double l3xt_p[16], *l3xt = l3xt_p;
    int l3xt_len = expansionObject::Gen_Product_With_PreAlloc(
        l3x_len, l3x, d4_len, d4, &l3xt, 16);
    double l3yt_p[16], *l3yt = l3yt_p;
    int l3yt_len = expansionObject::Gen_Product_With_PreAlloc(
        l3y_len, l3y, d4_len, d4, &l3yt, 16);
    double l4x1_p[16], *l4x1 = l4x1_p;
    int l4x1_len = expansionObject::Gen_Product_With_PreAlloc(
        l4x_len, l4x, d1_len, d1, &l4x1, 16);
    double l4y1_p[16], *l4y1 = l4y1_p;
    int l4y1_len = expansionObject::Gen_Product_With_PreAlloc(
        l4y_len, l4y, d1_len, d1, &l4y1, 16);
    double adx_p[16], *adx = adx_p;
    int adx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1xt_len, l1xt, l4x1_len, l4x1, &adx, 16);
    double ady_p[16], *ady = ady_p;
    int ady_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1yt_len, l1yt, l4y1_len, l4y1, &ady, 16);
    double l4x2_p[16], *l4x2 = l4x2_p;
    int l4x2_len = expansionObject::Gen_Product_With_PreAlloc(
        l4x_len, l4x, d2_len, d2, &l4x2, 16);
    double l4y2_p[16], *l4y2 = l4y2_p;
    int l4y2_len = expansionObject::Gen_Product_With_PreAlloc(
        l4y_len, l4y, d2_len, d2, &l4y2, 16);
    double bdx_p[16], *bdx = bdx_p;
    int bdx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2xt_len, l2xt, l4x2_len, l4x2, &bdx, 16);
    double bdy_p[16], *bdy = bdy_p;
    int bdy_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2yt_len, l2yt, l4y2_len, l4y2, &bdy, 16);
    double l4x3_p[16], *l4x3 = l4x3_p;
    int l4x3_len = expansionObject::Gen_Product_With_PreAlloc(
        l4x_len, l4x, d3_len, d3, &l4x3, 16);
    double l4y3_p[16], *l4y3 = l4y3_p;
    int l4y3_len = expansionObject::Gen_Product_With_PreAlloc(
        l4y_len, l4y, d3_len, d3, &l4y3, 16);
    double cdx_p[16], *cdx = cdx_p;
    int cdx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3xt_len, l3xt, l4x3_len, l4x3, &cdx, 16);
    double cdy_p[16], *cdy = cdy_p;
    int cdy_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3yt_len, l3yt, l4y3_len, l4y3, &cdy, 16);
    double abdeta_p[16], *abdeta = abdeta_p;
    int abdeta_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, bdy_len, bdy, &abdeta, 16);
    double abdetb_p[16], *abdetb = abdetb_p;
    int abdetb_len = expansionObject::Gen_Product_With_PreAlloc(
        bdx_len, bdx, ady_len, ady, &abdetb, 16);
    double abdet_p[16], *abdet = abdet_p;
    int abdet_len = expansionObject::Gen_Diff_With_PreAlloc(
        abdeta_len, abdeta, abdetb_len, abdetb, &abdet, 16);
    double bcdeta_p[16], *bcdeta = bcdeta_p;
    int bcdeta_len = expansionObject::Gen_Product_With_PreAlloc(
        bdx_len, bdx, cdy_len, cdy, &bcdeta, 16);
    double bcdetb_p[16], *bcdetb = bcdetb_p;
    int bcdetb_len = expansionObject::Gen_Product_With_PreAlloc(
        cdx_len, cdx, bdy_len, bdy, &bcdetb, 16);
    double bcdet_p[16], *bcdet = bcdet_p;
    int bcdet_len = expansionObject::Gen_Diff_With_PreAlloc(
        bcdeta_len, bcdeta, bcdetb_len, bcdetb, &bcdet, 16);
    double cadeta_p[16], *cadeta = cadeta_p;
    int cadeta_len = expansionObject::Gen_Product_With_PreAlloc(
        cdx_len, cdx, ady_len, ady, &cadeta, 16);
    double cadetb_p[16], *cadetb = cadetb_p;
    int cadetb_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, cdy_len, cdy, &cadetb, 16);
    double cadet_p[16], *cadet = cadet_p;
    int cadet_len = expansionObject::Gen_Diff_With_PreAlloc(
        cadeta_len, cadeta, cadetb_len, cadetb, &cadet, 16);
    double alifta_p[16], *alifta = alifta_p;
    int alifta_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, adx_len, adx, &alifta, 16);
    double aliftb_p[16], *aliftb = aliftb_p;
    int aliftb_len = expansionObject::Gen_Product_With_PreAlloc(
        ady_len, ady, ady_len, ady, &aliftb, 16);
    double aliftt_p[16], *aliftt = aliftt_p;
    int aliftt_len = expansionObject::Gen_Sum_With_PreAlloc(
        alifta_len, alifta, aliftb_len, aliftb, &aliftt, 16);
    double alift2_p[16], *alift2 = alift2_p;
    int alift2_len = expansionObject::Gen_Product_With_PreAlloc(
        aliftt_len, aliftt, d2_len, d2, &alift2, 16);
    double alift_p[16], *alift = alift_p;
    int alift_len = expansionObject::Gen_Product_With_PreAlloc(
        alift2_len, alift2, d3_len, d3, &alift, 16);
    double blifta_p[16], *blifta = blifta_p;
    int blifta_len = expansionObject::Gen_Product_With_PreAlloc(
        bdx_len, bdx, bdx_len, bdx, &blifta, 16);
    double bliftb_p[16], *bliftb = bliftb_p;
    int bliftb_len = expansionObject::Gen_Product_With_PreAlloc(
        bdy_len, bdy, bdy_len, bdy, &bliftb, 16);
    double bliftt_p[16], *bliftt = bliftt_p;
    int bliftt_len = expansionObject::Gen_Sum_With_PreAlloc(
        blifta_len, blifta, bliftb_len, bliftb, &bliftt, 16);
    double blift_p[16], *blift = blift_p;
    int blift_len = expansionObject::Gen_Product_With_PreAlloc(
        bliftt_len, bliftt, d3_len, d3, &blift, 16);
    double clifta_p[16], *clifta = clifta_p;
    int clifta_len = expansionObject::Gen_Product_With_PreAlloc(
        cdx_len, cdx, cdx_len, cdx, &clifta, 16);
    double cliftb_p[16], *cliftb = cliftb_p;
    int cliftb_len = expansionObject::Gen_Product_With_PreAlloc(
        cdy_len, cdy, cdy_len, cdy, &cliftb, 16);
    double cliftt_p[16], *cliftt = cliftt_p;
    int cliftt_len = expansionObject::Gen_Sum_With_PreAlloc(
        clifta_len, clifta, cliftb_len, cliftb, &cliftt, 16);
    double clift_p[16], *clift = clift_p;
    int clift_len = expansionObject::Gen_Product_With_PreAlloc(
        cliftt_len, cliftt, d2_len, d2, &clift, 16);
    double la_p[16], *la = la_p;
    int la_len = expansionObject::Gen_Product_With_PreAlloc(
        alift_len, alift, bcdet_len, bcdet, &la, 16);
    double lb_p[16], *lb = lb_p;
    int lb_len = expansionObject::Gen_Product_With_PreAlloc(
        blift_len, blift, cadet_len, cadet, &lb, 16);
    double lc_p[16], *lc = lc_p;
    int lc_len = expansionObject::Gen_Product_With_PreAlloc(
        clift_len, clift, abdet_len, abdet, &lc, 16);
    double lab2_p[16], *lab2 = lab2_p;
    int lab2_len = expansionObject::Gen_Sum_With_PreAlloc(lc_len, lc, lb_len,
                                                          lb, &lab2, 16);
    double lab_p[16], *lab = lab_p;
    int lab_len = expansionObject::Gen_Product_With_PreAlloc(
        lab2_len, lab2, d1_len, d1, &lab, 16);
    double L_p[16], *L = L_p;
    int L_len = expansionObject::Gen_Sum_With_PreAlloc(lab_len, lab, la_len, la,
                                                       &L, 16);
...
inline int incircle_indirect_IIII_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0) &&
    ...
    int l1xt_len = expansionObject::Gen_Product_With_PreAlloc(
        l1x_len, l1x, d4_len, d4, &l1xt, 32);
    double l1yt_p[32], *l1yt = l1yt_p;
    int l1yt_len = expansionObject::Gen_Product_With_PreAlloc(
        l1y_len, l1y, d4_len, d4, &l1yt, 32);
    double l2xt_p[32], *l2xt = l2xt_p;
    int l2xt_len = expansionObject::Gen_Product_With_PreAlloc(
        l2x_len, l2x, d4_len, d4, &l2xt, 32);
    double l2yt_p[32], *l2yt = l2yt_p;
    int l2yt_len = expansionObject::Gen_Product_With_PreAlloc(
        l2y_len, l2y, d4_len, d4, &l2yt, 32);
    double l3xt_p[32], *l3xt = l3xt_p;
    int l3xt_len = expansionObject::Gen_Product_With_PreAlloc(
        l3x_len, l3x, d4_len, d4, &l3xt, 32);
    double l3yt_p[32], *l3yt = l3yt_p;
    int l3yt_len = expansionObject::Gen_Product_With_PreAlloc(
        l3y_len, l3y, d4_len, d4, &l3yt, 32);
    double l4x1_p[32], *l4x1 = l4x1_p;
    int l4x1_len = expansionObject::Gen_Product_With_PreAlloc(
        l4x_len, l4x, d1_len, d1, &l4x1, 32);
    double l4y1_p[32], *l4y1 = l4y1_p;
    int l4y1_len = expansionObject::Gen_Product_With_PreAlloc(
        l4y_len, l4y, d1_len, d1, &l4y1, 32);
    double adx_p[32], *adx = adx_p;
    int adx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1xt_len, l1xt, l4x1_len, l4x1, &adx, 32);
    double ady_p[32], *ady = ady_p;
    int ady_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1yt_len, l1yt, l4y1_len, l4y1, &ady, 32);
    double l4x2_p[32], *l4x2 = l4x2_p;
    int l4x2_len = expansionObject::Gen_Product_With_PreAlloc(
        l4x_len, l4x, d2_len, d2, &l4x2, 32);
    double l4y2_p[32], *l4y2 = l4y2_p;
    int l4y2_len = expansionObject::Gen_Product_With_PreAlloc(
        l4y_len, l4y, d2_len, d2, &l4y2, 32);
    double bdx_p[32], *bdx = bdx_p;
    int bdx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2xt_len, l2xt, l4x2_len, l4x2, &bdx, 32);
    double bdy_p[32], *bdy = bdy_p;
    int bdy_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2yt_len, l2yt, l4y2_len, l4y2, &bdy, 32);
    double l4x3_p[32], *l4x3 = l4x3_p;
    int l4x3_len = expansionObject::Gen_Product_With_PreAlloc(
        l4x_len, l4x, d3_len, d3, &l4x3, 32);
    double l4y3_p[32], *l4y3 = l4y3_p;
    int l4y3_len = expansionObject::Gen_Product_With_PreAlloc(
        l4y_len, l4y, d3_len, d3, &l4y3, 32);
    double cdx_p[32], *cdx = cdx_p;
    int cdx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3xt_len, l3xt, l4x3_len, l4x3, &cdx, 32);
    double cdy_p[32], *cdy = cdy_p;
    int cdy_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3yt_len, l3yt, l4y3_len, l4y3, &cdy, 32);
    double abdeta_p[32], *abdeta = abdeta_p;
    int abdeta_len = expansionObject::Gen_Product_With_PreAlloc(
        adx_len, adx, bdy_len, bdy, &abdeta, 32);
    double abdetb_p[32], *abdetb = abdetb_p;
...
inline int inSphere_IEEEE_exact(const genericPoint &p1, double pbx, double pby,
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int pexd_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, pex, &pexd, 16);
    double peyd_p[16], *peyd = peyd_p;
    int peyd_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, pey, &peyd, 16);
    double pezd_p[16], *pezd = pezd_p;
    int pezd_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, pez, &pezd, 16);
    double aex_p[16], *aex = aex_p;
    int aex_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1x_len, l1x, pexd_len, pexd, &aex, 16);
    double aey_p[16], *aey = aey_p;
    int aey_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1y_len, l1y, peyd_len, peyd, &aey, 16);
    double aez_p[16], *aez = aez_p;
    int aez_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1z_len, l1z, pezd_len, pezd, &aez, 16);
    double bex[2];
    expansionObject::two_Diff(pbx, pex, bex);
    double bey[2];
    expansionObject::two_Diff(pby, pey, bey);
    ...
    int aexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, 2, bey, &aexbey, 16);
    double bexaey_p[16], *bexaey = bexaey_p;
    int bexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        2, bex, aey_len, aey, &bexaey, 16);
    double ab_p[16], *ab = ab_p;
    int ab_len = expansionObject::Gen_Diff_With_PreAlloc(
        aexbey_len, aexbey, bexaey_len, bexaey, &ab, 16);
    double bexcey[8];
    int bexcey_len = expansionObject::Gen_Product(2, bex, 2, cey, bexcey);
    double cexbey[8];
    int cexbey_len = expansionObject::Gen_Product(2, cex, 2, bey, cexbey);
    ...
    int dexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        2, dex, aey_len, aey, &dexaey, 16);
    double aexdey_p[16], *aexdey = aexdey_p;
    int aexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, 2, dey, &aexdey, 16);
    double da_p[16], *da = da_p;
    int da_len = expansionObject::Gen_Diff_With_PreAlloc(
        dexaey_len, dexaey, aexdey_len, aexdey, &da, 16);
    double aexcey_p[16], *aexcey = aexcey_p;
    int aexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, 2, cey, &aexcey, 16);
    double cexaey_p[16], *cexaey = cexaey_p;
    int cexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        2, cex, aey_len, aey, &cexaey, 16);
    double ac_p[16], *ac = ac_p;
    int ac_len = expansionObject::Gen_Diff_With_PreAlloc(
        aexcey_len, aexcey, cexaey_len, cexaey, &ac, 16);
    double bexdey[8];
    int bexdey_len = expansionObject::Gen_Product(2, bex, 2, dey, bexdey);
    double dexbey[8];
    int dexbey_len = expansionObject::Gen_Product(2, dex, 2, bey, dexbey);
    ...
    int abc1_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, bc_len, bc, &abc1, 16);
    double abc2_p[16], *abc2 = abc2_p;
    int abc2_len = expansionObject::Gen_Product_With_PreAlloc(2, bez, ac_len,
                                                              ac, &abc2, 16);
    double abc3_p[16], *abc3 = abc3_p;
    int abc3_len = expansionObject::Gen_Product_With_PreAlloc(2, cez, ab_len,
                                                              ab, &abc3, 16);
    double abc4_p[16], *abc4 = abc4_p;
    int abc4_len = expansionObject::Gen_Sum_With_PreAlloc(
        abc1_len, abc1, abc3_len, abc3, &abc4, 16);
    double abc_p[16], *abc = abc_p;
    int abc_len = expansionObject::Gen_Diff_With_PreAlloc(
        abc4_len, abc4, abc2_len, abc2, &abc, 16);
    double bcd1_p[16], *bcd1 = bcd1_p;
    int bcd1_len = expansionObject::Gen_Product_With_PreAlloc(2, bez, cd_len,
                                                              cd, &bcd1, 16);
    double bcd2_p[16], *bcd2 = bcd2_p;
    int bcd2_len = expansionObject::Gen_Product_With_PreAlloc(2, cez, bd_len,
                                                              bd, &bcd2, 16);
    double bcd3_p[16], *bcd3 = bcd3_p;
    int bcd3_len = expansionObject::Gen_Product_With_PreAlloc(2, dez, bc_len,
                                                              bc, &bcd3, 16);
    double bcd4_p[16], *bcd4 = bcd4_p;
    int bcd4_len = expansionObject::Gen_Sum_With_PreAlloc(
        bcd1_len, bcd1, bcd3_len, bcd3, &bcd4, 16);
    double bcd_p[16], *bcd = bcd_p;
    int bcd_len = expansionObject::Gen_Diff_With_PreAlloc(
        bcd4_len, bcd4, bcd2_len, bcd2, &bcd, 16);
    double cda1_p[16], *cda1 = cda1_p;
    int cda1_len = expansionObject::Gen_Product_With_PreAlloc(2, cez, da_len,
                                                              da, &cda1, 16);
    double cda2_p[16], *cda2 = cda2_p;
    int cda2_len = expansionObject::Gen_Product_With_PreAlloc(2, dez, ac_len,
                                                              ac, &cda2, 16);
    double cda3_p[16], *cda3 = cda3_p;
    int cda3_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, cd_len, cd, &cda3, 16);
    double cda4_p[16], *cda4 = cda4_p;
    int cda4_len = expansionObject::Gen_Sum_With_PreAlloc(
        cda1_len, cda1, cda3_len, cda3, &cda4, 16);
    double cda_p[16], *cda = cda_p;
    int cda_len = expansionObject::Gen_Sum_With_PreAlloc(
        cda4_len, cda4, cda2_len, cda2, &cda, 16);
    double dab1_p[16], *dab1 = dab1_p;
    int dab1_len = expansionObject::Gen_Product_With_PreAlloc(2, dez, ab_len,
                                                              ab, &dab1, 16);
    double dab2_p[16], *dab2 = dab2_p;
    int dab2_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, bd_len, bd, &dab2, 16);
    double dab3_p[16], *dab3 = dab3_p;
    int dab3_len = expansionObject::Gen_Product_With_PreAlloc(2, bez, da_len,
                                                              da, &dab3, 16);
    double dab4_p[16], *dab4 = dab4_p;
    int dab4_len = expansionObject::Gen_Sum_With_PreAlloc(
        dab1_len, dab1, dab3_len, dab3, &dab4, 16);
    double dab_p[16], *dab = dab_p;
    int dab_len = expansionObject::Gen_Sum_With_PreAlloc(
        dab4_len, dab4, dab2_len, dab2, &dab, 16);
    double al1_p[16], *al1 = al1_p;
    int al1_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, aex_len, aex, &al1, 16);
    double al2_p[16], *al2 = al2_p;
    int al2_len = expansionObject::Gen_Product_With_PreAlloc(
        aey_len, aey, aey_len, aey, &al2, 16);
    double al3_p[16], *al3 = al3_p;
    int al3_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, aez_len, aez, &al3, 16);
    double al4_p[16], *al4 = al4_p;
    int al4_len = expansionObject::Gen_Sum_With_PreAlloc(al1_len, al1, al2_len,
                                                         al2, &al4, 16);
    double alift_p[16], *alift = alift_p;
    int alift_len = expansionObject::Gen_Sum_With_PreAlloc(
        al4_len, al4, al3_len, al3, &alift, 16);
    double bl1[8];
    int bl1_len = expansionObject::Gen_Product(2, bex, 2, bex, bl1);
    double bl2[8];
    int bl2_len = expansionObject::Gen_Product(2, bey, 2, bey, bl2);
    ...
    double blift_p[16], *blift = blift_p;
    int blift_len = expansionObject::Gen_Sum_With_PreAlloc(
        bl4_len, bl4, bl3_len, bl3, &blift, 16);
    double cl1[8];
    int cl1_len = expansionObject::Gen_Product(2, cex, 2, cex, cl1);
    double cl2[8];
    int cl2_len = expansionObject::Gen_Product(2, cey, 2, cey, cl2);
    ...
    int cl4_len = expansionObject::Gen_Sum(cl1_len, cl1, cl2_len, cl2, cl4);
    double clift_p[16], *clift = clift_p;
    int clift_len = expansionObject::Gen_Sum_With_PreAlloc(
        cl4_len, cl4, cl3_len, cl3, &clift, 16);
    double dl1[8];
    int dl1_len = expansionObject::Gen_Product(2, dex, 2, dex, dl1);
    double dl2[8];
    int dl2_len = expansionObject::Gen_Product(2, dey, 2, dey, dl2);
    ...
    int dlift_len = expansionObject::Gen_Sum_With_PreAlloc(
        dl4_len, dl4, dl3_len, dl3, &dlift, 16);
    double ds1_p[16], *ds1 = ds1_p;
    int ds1_len = expansionObject::Gen_Product_With_PreAlloc(
        dlift_len, dlift, abc_len, abc, &ds1, 16);
    double ds2_p[16], *ds2 = ds2_p;
    int ds2_len = expansionObject::Gen_Product_With_PreAlloc(
        clift_len, clift, dab_len, dab, &ds2, 16);
    double dlp_p[16], *dlp = dlp_p;
    int dlp_len = expansionObject::Gen_Diff_With_PreAlloc(ds2_len, ds2, ds1_len,
                                                          ds1, &dlp, 16);
    double dl_p[16], *dl = dl_p;
    int dl_len = expansionObject::Gen_Product_With_PreAlloc(
        dlp_len, dlp, d1_len, d1, &dl, 16);
    double dr1p_p[16], *dr1p = dr1p_p;
    int dr1p_len = expansionObject::Gen_Product_With_PreAlloc(
        blift_len, blift, cda_len, cda, &dr1p, 16);
    double dr1_p[16], *dr1 = dr1_p;
    int dr1_len = expansionObject::Gen_Product_With_PreAlloc(
        dr1p_len, dr1p, d1_len, d1, &dr1, 16);
    double dr2_p[16], *dr2 = dr2_p;
    int dr2_len = expansionObject::Gen_Product_With_PreAlloc(
        alift_len, alift, bcd_len, bcd, &dr2, 16);
    double dr_p[16], *dr = dr_p;
    int dr_len = expansionObject::Gen_Diff_With_PreAlloc(dr2_len, dr2, dr1_len,
                                                         dr1, &dr, 16);
    double det_p[16], *det = det_p;
    int det_len = expansionObject::Gen_Sum_With_PreAlloc(dl_len, dl, dr_len, dr,
                                                         &det, 16);
...
inline int inSphere_IIEEE_exact(const genericPoint &p1, const genericPoint &p2,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    int pexd2_len =
        expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, pex, &pexd2, 16);
    double peyd2_p[16], *peyd2 = peyd2_p;
    int peyd2_len =
        expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, pey, &peyd2, 16);
    double pezd2_p[16], *pezd2 = pezd2_p;
    int pezd2_len =
        expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, pez, &pezd2, 16);
    double bex_p[16], *bex = bex_p;
    int bex_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2x_len, l2x, pexd2_len, pexd2, &bex, 16);
    double bey_p[16], *bey = bey_p;
    int bey_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2y_len, l2y, peyd2_len, peyd2, &bey, 16);
    double bez_p[16], *bez = bez_p;
    int bez_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2z_len, l2z, pezd2_len, pezd2, &bez, 16);
    double cex[2];
    expansionObject::two_Diff(pcx, pex, cex);
    double cey[2];
    expansionObject::two_Diff(pcy, pey, cey);
    ...
    double aexbey_p[16], *aexbey = aexbey_p;
    int aexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, bey_len, bey, &aexbey, 16);
    double bexaey_p[16], *bexaey = bexaey_p;
    int bexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, aey_len, aey, &bexaey, 16);
    double ab_p[16], *ab = ab_p;
    int ab_len = expansionObject::Gen_Diff_With_PreAlloc(
        aexbey_len, aexbey, bexaey_len, bexaey, &ab, 16);
    double bexcey_p[16], *bexcey = bexcey_p;
    int bexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, 2, cey, &bexcey, 16);
    double cexbey_p[16], *cexbey = cexbey_p;
    int cexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        2, cex, bey_len, bey, &cexbey, 16);
    double bc_p[16], *bc = bc_p;
    int bc_len = expansionObject::Gen_Diff_With_PreAlloc(
        bexcey_len, bexcey, cexbey_len, cexbey, &bc, 16);
    double cexdey[8];
    int cexdey_len = expansionObject::Gen_Product(2, cex, 2, dey, cexdey);
    double dexcey[8];
    int dexcey_len = expansionObject::Gen_Product(2, dex, 2, cey, dexcey);
    ...
    int bexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, 2, dey, &bexdey, 16);
    double dexbey_p[16], *dexbey = dexbey_p;
    int dexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        2, dex, bey_len, bey, &dexbey, 16);
    double bd_p[16], *bd = bd_p;
    int bd_len = expansionObject::Gen_Diff_With_PreAlloc(
        bexdey_len, bexdey, dexbey_len, dexbey, &bd, 16);
    double abc1_p[16], *abc1 = abc1_p;
    int abc1_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, bc_len, bc, &abc1, 16);
    double abc2_p[16], *abc2 = abc2_p;
    int abc2_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, ac_len, ac, &abc2, 16);
    double abc3_p[16], *abc3 = abc3_p;
    int abc3_len = expansionObject::Gen_Product_With_PreAlloc(2, cez, ab_len,
                                                              ab, &abc3, 16);
    double abc4_p[16], *abc4 = abc4_p;
    ...
    int abc_len = expansionObject::Gen_Diff_With_PreAlloc(
        abc4_len, abc4, abc2_len, abc2, &abc, 16);
    double bcd1_p[16], *bcd1 = bcd1_p;
    int bcd1_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, cd_len, cd, &bcd1, 16);
    double bcd2_p[16], *bcd2 = bcd2_p;
    int bcd2_len = expansionObject::Gen_Product_With_PreAlloc(2, cez, bd_len,
                                                              bd, &bcd2, 16);
    double bcd3_p[16], *bcd3 = bcd3_p;
    ...
    int dab2_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, bd_len, bd, &dab2, 16);
    double dab3_p[16], *dab3 = dab3_p;
    int dab3_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, da_len, da, &dab3, 16);
    double dab4_p[16], *dab4 = dab4_p;
    int dab4_len = expansionObject::Gen_Sum_With_PreAlloc(
        dab1_len, dab1, dab3_len, dab3, &dab4, 16);
    double dab_p[16], *dab = dab_p;
    ...
    int bl1_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, bex_len, bex, &bl1, 16);
    double bl2_p[16], *bl2 = bl2_p;
    int bl2_len = expansionObject::Gen_Product_With_PreAlloc(
        bey_len, bey, bey_len, bey, &bl2, 16);
    double bl3_p[16], *bl3 = bl3_p;
    int bl3_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, bez_len, bez, &bl3, 16);
    double bl4_p[16], *bl4 = bl4_p;
    int bl4_len = expansionObject::Gen_Sum_With_PreAlloc(bl1_len, bl1, bl2_len,
                                                         bl2, &bl4, 16);
    double blift_p[16], *blift = blift_p;
    int blift_len = expansionObject::Gen_Sum_With_PreAlloc(
        bl4_len, bl4, bl3_len, bl3, &blift, 16);
    ...
    int dll_len = expansionObject::Gen_Product_With_PreAlloc(dl_len, dl, d1_len,
                                                             d1, &dll, 16);
    double dlll_p[16], *dlll = dlll_p;
    int dlll_len = expansionObject::Gen_Product_With_PreAlloc(
        dll_len, dll, d2_len, d2, &dlll, 16);
    double dr1_p[16], *dr1 = dr1_p;
    int dr1_len = expansionObject::Gen_Product_With_PreAlloc(
        blift_len, blift, cda_len, cda, &dr1, 16);
    double dr12_p[16], *dr12 = dr12_p;
    int dr12_len = expansionObject::Gen_Product_With_PreAlloc(
        dr1_len, dr1, d1_len, d1, &dr12, 16);
    double dr2_p[16], *dr2 = dr2_p;
    int dr2_len = expansionObject::Gen_Product_With_PreAlloc(
        alift_len, alift, bcd_len, bcd, &dr2, 16);
    double dr22_p[16], *dr22 = dr22_p;
    int dr22_len = expansionObject::Gen_Product_With_PreAlloc(
        dr2_len, dr2, d2_len, d2, &dr22, 16);
    double dr_p[16], *dr = dr_p;
    int dr_len = expansionObject::Gen_Diff_With_PreAlloc(
        dr22_len, dr22, dr12_len, dr12, &dr, 16);
    double det_p[16], *det = det_p;
    int det_len = expansionObject::Gen_Sum_With_PreAlloc(dlll_len, dlll, dr_len,
                                                         dr, &det, 16);
...
inline int inSphere_IIIEE_exact(const genericPoint &p1, const genericPoint &p2,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0)) {
    ...
    int pexd3_len =
        expansionObject::Gen_Scale_With_PreAlloc(d3_len, d3, pex, &pexd3, 16);
    double peyd3_p[16], *peyd3 = peyd3_p;
    int peyd3_len =
        expansionObject::Gen_Scale_With_PreAlloc(d3_len, d3, pey, &peyd3, 16);
    double pezd3_p[16], *pezd3 = pezd3_p;
    int pezd3_len =
        expansionObject::Gen_Scale_With_PreAlloc(d3_len, d3, pez, &pezd3, 16);
    double cex_p[16], *cex = cex_p;
    int cex_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3x_len, l3x, pexd3_len, pexd3, &cex, 16);
    double cey_p[16], *cey = cey_p;
    int cey_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3y_len, l3y, peyd3_len, peyd3, &cey, 16);
    double cez_p[16], *cez = cez_p;
    int cez_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3z_len, l3z, pezd3_len, pezd3, &cez, 16);
    double dex[2];
    expansionObject::two_Diff(pdx, pex, dex);
    double dey[2];
    expansionObject::two_Diff(pdy, pey, dey);
    ...
    double bexcey_p[16], *bexcey = bexcey_p;
    int bexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, cey_len, cey, &bexcey, 16);
    double cexbey_p[16], *cexbey = cexbey_p;
    int cexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, bey_len, bey, &cexbey, 16);
    double bc_p[16], *bc = bc_p;
    int bc_len = expansionObject::Gen_Diff_With_PreAlloc(
        bexcey_len, bexcey, cexbey_len, cexbey, &bc, 16);
    double cexdey_p[16], *cexdey = cexdey_p;
    int cexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, 2, dey, &cexdey, 16);
    double dexcey_p[16], *dexcey = dexcey_p;
    int dexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        2, dex, cey_len, cey, &dexcey, 16);
    double cd_p[16], *cd = cd_p;
    int cd_len = expansionObject::Gen_Diff_With_PreAlloc(
        cexdey_len, cexdey, dexcey_len, dexcey, &cd, 16);
    double dexaey_p[16], *dexaey = dexaey_p;
    int dexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        2, dex, aey_len, aey, &dexaey, 16);
    double aexdey_p[16], *aexdey = aexdey_p;
    ...
    double aexcey_p[16], *aexcey = aexcey_p;
    int aexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, cey_len, cey, &aexcey, 16);
    double cexaey_p[16], *cexaey = cexaey_p;
    int cexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, aey_len, aey, &cexaey, 16);
    double ac_p[16], *ac = ac_p;
    int ac_len = expansionObject::Gen_Diff_With_PreAlloc(
        aexcey_len, aexcey, cexaey_len, cexaey, &ac, 16);
    double bexdey_p[16], *bexdey = bexdey_p;
    ...
    int abc2_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, ac_len, ac, &abc2, 16);
    double abc3_p[16], *abc3 = abc3_p;
    int abc3_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, ab_len, ab, &abc3, 16);
    double abc4_p[16], *abc4 = abc4_p;
    int abc4_len = expansionObject::Gen_Sum_With_PreAlloc(
        abc1_len, abc1, abc3_len, abc3, &abc4, 16);
    double abc_p[16], *abc = abc_p;
    ...
    int bcd1_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, cd_len, cd, &bcd1, 16);
    double bcd2_p[16], *bcd2 = bcd2_p;
    int bcd2_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, bd_len, bd, &bcd2, 16);
    double bcd3_p[16], *bcd3 = bcd3_p;
    int bcd3_len = expansionObject::Gen_Product_With_PreAlloc(2, dez, bc_len,
                                                              bc, &bcd3, 16);
    double bcd4_p[16], *bcd4 = bcd4_p;
    ...
    int bcd_len = expansionObject::Gen_Diff_With_PreAlloc(
        bcd4_len, bcd4, bcd2_len, bcd2, &bcd, 16);
    double cda1_p[16], *cda1 = cda1_p;
    int cda1_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, da_len, da, &cda1, 16);
    double cda2_p[16], *cda2 = cda2_p;
    int cda2_len = expansionObject::Gen_Product_With_PreAlloc(2, dez, ac_len,
                                                              ac, &cda2, 16);
    double cda3_p[16], *cda3 = cda3_p;
    ...
    int cl1_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, cex_len, cex, &cl1, 16);
    double cl2_p[16], *cl2 = cl2_p;
    int cl2_len = expansionObject::Gen_Product_With_PreAlloc(
        cey_len, cey, cey_len, cey, &cl2, 16);
    double cl3_p[16], *cl3 = cl3_p;
    int cl3_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, cez_len, cez, &cl3, 16);
    double cl4_p[16], *cl4 = cl4_p;
    int cl4_len = expansionObject::Gen_Sum_With_PreAlloc(cl1_len, cl1, cl2_len,
                                                         cl2, &cl4, 16);
    double clift_p[16], *clift = clift_p;
    int clift_len = expansionObject::Gen_Sum_With_PreAlloc(
        cl4_len, cl4, cl3_len, cl3, &clift, 16);
    ...
    int ds1n_len = expansionObject::Gen_Product_With_PreAlloc(
        ds1_len, ds1, d3_len, d3, &ds1n, 16);
    double ds2_p[16], *ds2 = ds2_p;
    int ds2_len = expansionObject::Gen_Product_With_PreAlloc(
        clift_len, clift, dab_len, dab, &ds2, 16);
    double dl_p[16], *dl = dl_p;
    int dl_len = expansionObject::Gen_Diff_With_PreAlloc(ds2_len, ds2, ds1n_len,
                                                         ds1n, &dl, 16);
    double dlm_p[16], *dlm = dlm_p;
    int dlm_len = expansionObject::Gen_Product_With_PreAlloc(dl_len, dl, d1_len,
                                                             d1, &dlm, 16);
    double dln_p[16], *dln = dln_p;
    int dln_len = expansionObject::Gen_Product_With_PreAlloc(
        dlm_len, dlm, d2_len, d2, &dln, 16);
    double dr1_p[16], *dr1 = dr1_p;
    int dr1_len = expansionObject::Gen_Product_With_PreAlloc(
        blift_len, blift, cda_len, cda, &dr1, 16);
    double dr1n_p[16], *dr1n = dr1n_p;
    int dr1n_len = expansionObject::Gen_Product_With_PreAlloc(
        dr1_len, dr1, d1_len, d1, &dr1n, 16);
    double dr2_p[16], *dr2 = dr2_p;
    int dr2_len = expansionObject::Gen_Product_With_PreAlloc(
        alift_len, alift, bcd_len, bcd, &dr2, 16);
    double dr2n_p[16], *dr2n = dr2n_p;
    int dr2n_len = expansionObject::Gen_Product_With_PreAlloc(
        dr2_len, dr2, d2_len, d2, &dr2n, 16);
    double dr_p[16], *dr = dr_p;
    int dr_len = expansionObject::Gen_Diff_With_PreAlloc(
        dr2n_len, dr2n, dr1n_len, dr1n, &dr, 16);
    double drn_p[16], *drn = drn_p;
    int drn_len = expansionObject::Gen_Product_With_PreAlloc(dr_len, dr, d3_len,
                                                             d3, &drn, 16);
    double det_p[16], *det = det_p;
    int det_len = expansionObject::Gen_Sum_With_PreAlloc(dln_len, dln, drn_len,
                                                         drn, &det, 16);
...
inline int inSphere_IIIIE_exact(const genericPoint &p1, const genericPoint &p2,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0) &&
    ...
    int pexd4_len =
        expansionObject::Gen_Scale_With_PreAlloc(d4_len, d4, pex, &pexd4, 16);
    double peyd4_p[16], *peyd4 = peyd4_p;
    int peyd4_len =
        expansionObject::Gen_Scale_With_PreAlloc(d4_len, d4, pey, &peyd4, 16);
    double pezd4_p[16], *pezd4 = pezd4_p;
    int pezd4_len =
        expansionObject::Gen_Scale_With_PreAlloc(d4_len, d4, pez, &pezd4, 16);
    double dex_p[16], *dex = dex_p;
    int dex_len = expansionObject::Gen_Diff_With_PreAlloc(
        l4x_len, l4x, pexd4_len, pexd4, &dex, 16);
    double dey_p[16], *dey = dey_p;
    int dey_len = expansionObject::Gen_Diff_With_PreAlloc(
        l4y_len, l4y, peyd4_len, peyd4, &dey, 16);
    double dez_p[16], *dez = dez_p;
    int dez_len = expansionObject::Gen_Diff_With_PreAlloc(
        l4z_len, l4z, pezd4_len, pezd4, &dez, 16);
    double aexbey_p[16], *aexbey = aexbey_p;
    int aexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, bey_len, bey, &aexbey, 16);
    double bexaey_p[16], *bexaey = bexaey_p;
    ...
    double cexdey_p[16], *cexdey = cexdey_p;
    int cexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, dey_len, dey, &cexdey, 16);
    double dexcey_p[16], *dexcey = dexcey_p;
    int dexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        dex_len, dex, cey_len, cey, &dexcey, 16);
    double cd_p[16], *cd = cd_p;
    int cd_len = expansionObject::Gen_Diff_With_PreAlloc(
        cexdey_len, cexdey, dexcey_len, dexcey, &cd, 16);
    double dexaey_p[16], *dexaey = dexaey_p;
    int dexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        dex_len, dex, aey_len, aey, &dexaey, 16);
    double aexdey_p[16], *aexdey = aexdey_p;
    int aexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, dey_len, dey, &aexdey, 16);
    double da_p[16], *da = da_p;
    int da_len = expansionObject::Gen_Diff_With_PreAlloc(
        dexaey_len, dexaey, aexdey_len, aexdey, &da, 16);
    double aexcey_p[16], *aexcey = aexcey_p;
    ...
    double bexdey_p[16], *bexdey = bexdey_p;
    int bexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, dey_len, dey, &bexdey, 16);
    double dexbey_p[16], *dexbey = dexbey_p;
    int dexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        dex_len, dex, bey_len, bey, &dexbey, 16);
    double bd_p[16], *bd = bd_p;
    int bd_len = expansionObject::Gen_Diff_With_PreAlloc(
        bexdey_len, bexdey, dexbey_len, dexbey, &bd, 16);
    double abc1_p[16], *abc1 = abc1_p;
    ...
    int bcd2_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, bd_len, bd, &bcd2, 16);
    double bcd3_p[16], *bcd3 = bcd3_p;
    int bcd3_len = expansionObject::Gen_Product_With_PreAlloc(
        dez_len, dez, bc_len, bc, &bcd3, 16);
    double bcd4_p[16], *bcd4 = bcd4_p;
    int bcd4_len = expansionObject::Gen_Sum_With_PreAlloc(
        bcd1_len, bcd1, bcd3_len, bcd3, &bcd4, 16);
    double bcd_p[16], *bcd = bcd_p;
    ...
    int cda1_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, da_len, da, &cda1, 16);
    double cda2_p[16], *cda2 = cda2_p;
    int cda2_len = expansionObject::Gen_Product_With_PreAlloc(
        dez_len, dez, ac_len, ac, &cda2, 16);
    double cda3_p[16], *cda3 = cda3_p;
    int cda3_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, cd_len, cd, &cda3, 16);
    double cda4_p[16], *cda4 = cda4_p;
    ...
    int cda_len = expansionObject::Gen_Sum_With_PreAlloc(
        cda4_len, cda4, cda2_len, cda2, &cda, 16);
    double dab1_p[16], *dab1 = dab1_p;
    int dab1_len = expansionObject::Gen_Product_With_PreAlloc(
        dez_len, dez, ab_len, ab, &dab1, 16);
    double dab2_p[16], *dab2 = dab2_p;
    int dab2_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, bd_len, bd, &dab2, 16);
    double dab3_p[16], *dab3 = dab3_p;
    ...
    int dl1_len = expansionObject::Gen_Product_With_PreAlloc(
        dex_len, dex, dex_len, dex, &dl1, 16);
    double dl2_p[16], *dl2 = dl2_p;
    int dl2_len = expansionObject::Gen_Product_With_PreAlloc(
        dey_len, dey, dey_len, dey, &dl2, 16);
    double dl3_p[16], *dl3 = dl3_p;
    int dl3_len = expansionObject::Gen_Product_With_PreAlloc(
        dez_len, dez, dez_len, dez, &dl3, 16);
    double dl4_p[16], *dl4 = dl4_p;
    int dl4_len = expansionObject::Gen_Sum_With_PreAlloc(dl1_len, dl1, dl2_len,
                                                         dl2, &dl4, 16);
    double dlift_p[16], *dlift = dlift_p;
    int dlift_len = expansionObject::Gen_Sum_With_PreAlloc(
        dl4_len, dl4, dl3_len, dl3, &dlift, 16);
    ...
    int ds12_len = expansionObject::Gen_Product_With_PreAlloc(
        ds1_len, ds1, d3_len, d3, &ds12, 16);
    double ds2_p[16], *ds2 = ds2_p;
    int ds2_len = expansionObject::Gen_Product_With_PreAlloc(
        clift_len, clift, dab_len, dab, &ds2, 16);
    double ds22_p[16], *ds22 = ds22_p;
    int ds22_len = expansionObject::Gen_Product_With_PreAlloc(
        ds2_len, ds2, d4_len, d4, &ds22, 16);
    double dl_p[16], *dl = dl_p;
    int dl_len = expansionObject::Gen_Diff_With_PreAlloc(
        ds22_len, ds22, ds12_len, ds12, &dl, 16);
    double dlx1_p[16], *dlx1 = dlx1_p;
    int dlx1_len = expansionObject::Gen_Product_With_PreAlloc(
        dl_len, dl, d1_len, d1, &dlx1, 16);
    double dlx2_p[16], *dlx2 = dlx2_p;
    int dlx2_len = expansionObject::Gen_Product_With_PreAlloc(
        dlx1_len, dlx1, d2_len, d2, &dlx2, 16);
    double dr1_p[16], *dr1 = dr1_p;
    int dr1_len = expansionObject::Gen_Product_With_PreAlloc(
        blift_len, blift, cda_len, cda, &dr1, 16);
    double dr12_p[16], *dr12 = dr12_p;
    ...
    int drx1_len = expansionObject::Gen_Product_With_PreAlloc(
        dr_len, dr, d3_len, d3, &drx1, 16);
    double drx2_p[16], *drx2 = drx2_p;
    int drx2_len = expansionObject::Gen_Product_With_PreAlloc(
        drx1_len, drx1, d4_len, d4, &drx2, 16);
    double det_p[16], *det = det_p;
    int det_len = expansionObject::Gen_Sum_With_PreAlloc(
        dlx2_len, dlx2, drx2_len, drx2, &det, 16);
...
inline int inSphere_IIIII_exact(const genericPoint &p1, const genericPoint &p2,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0) &&
    ...
    int pexd_len = expansionObject::Gen_Product_With_PreAlloc(
        l5x_len, l5x, d1_len, d1, &pexd, 8);
    double peyd_p[8], *peyd = peyd_p;
    int peyd_len = expansionObject::Gen_Product_With_PreAlloc(
        l5y_len, l5y, d1_len, d1, &peyd, 8);
    double pezd_p[8], *pezd = pezd_p;
    int pezd_len = expansionObject::Gen_Product_With_PreAlloc(
        l5z_len, l5z, d1_len, d1, &pezd, 8);
    double ll1x_p[8], *ll1x = ll1x_p;
    int ll1x_len = expansionObject::Gen_Product_With_PreAlloc(
        l1x_len, l1x, d5_len, d5, &ll1x, 8);
    double ll1y_p[8], *ll1y = ll1y_p;
    int ll1y_len = expansionObject::Gen_Product_With_PreAlloc(
        l1y_len, l1y, d5_len, d5, &ll1y, 8);
    double ll1z_p[8], *ll1z = ll1z_p;
    int ll1z_len = expansionObject::Gen_Product_With_PreAlloc(
        l1z_len, l1z, d5_len, d5, &ll1z, 8);
    double aex_p[8], *aex = aex_p;
    int aex_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll1x_len, ll1x, pexd_len, pexd, &aex, 8);
    double aey_p[8], *aey = aey_p;
    int aey_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll1y_len, ll1y, peyd_len, peyd, &aey, 8);
    double aez_p[8], *aez = aez_p;
    int aez_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll1z_len, ll1z, pezd_len, pezd, &aez, 8);
    double pexd2_p[8], *pexd2 = pexd2_p;
    int pexd2_len = expansionObject::Gen_Product_With_PreAlloc(
        l5x_len, l5x, d2_len, d2, &pexd2, 8);
    double peyd2_p[8], *peyd2 = peyd2_p;
    int peyd2_len = expansionObject::Gen_Product_With_PreAlloc(
        l5y_len, l5y, d2_len, d2, &peyd2, 8);
    double pezd2_p[8], *pezd2 = pezd2_p;
    int pezd2_len = expansionObject::Gen_Product_With_PreAlloc(
        l5z_len, l5z, d2_len, d2, &pezd2, 8);
    double ll2x_p[8], *ll2x = ll2x_p;
    int ll2x_len = expansionObject::Gen_Product_With_PreAlloc(
        l2x_len, l2x, d5_len, d5, &ll2x, 8);
    double ll2y_p[8], *ll2y = ll2y_p;
    int ll2y_len = expansionObject::Gen_Product_With_PreAlloc(
        l2y_len, l2y, d5_len, d5, &ll2y, 8);
    double ll2z_p[8], *ll2z = ll2z_p;
    int ll2z_len = expansionObject::Gen_Product_With_PreAlloc(
        l2z_len, l2z, d5_len, d5, &ll2z, 8);
    double bex_p[8], *bex = bex_p;
    int bex_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll2x_len, ll2x, pexd2_len, pexd2, &bex, 8);
    double bey_p[8], *bey = bey_p;
    int bey_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll2y_len, ll2y, peyd2_len, peyd2, &bey, 8);
    double bez_p[8], *bez = bez_p;
    int bez_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll2z_len, ll2z, pezd2_len, pezd2, &bez, 8);
    double pexd3_p[8], *pexd3 = pexd3_p;
    int pexd3_len = expansionObject::Gen_Product_With_PreAlloc(
        l5x_len, l5x, d3_len, d3, &pexd3, 8);
    double peyd3_p[8], *peyd3 = peyd3_p;
    int peyd3_len = expansionObject::Gen_Product_With_PreAlloc(
        l5y_len, l5y, d3_len, d3, &peyd3, 8);
    double pezd3_p[8], *pezd3 = pezd3_p;
    int pezd3_len = expansionObject::Gen_Product_With_PreAlloc(
        l5z_len, l5z, d3_len, d3, &pezd3, 8);
    double ll3x_p[8], *ll3x = ll3x_p;
    int ll3x_len = expansionObject::Gen_Product_With_PreAlloc(
        l3x_len, l3x, d5_len, d5, &ll3x, 8);
    double ll3y_p[8], *ll3y = ll3y_p;
    int ll3y_len = expansionObject::Gen_Product_With_PreAlloc(
        l3y_len, l3y, d5_len, d5, &ll3y, 8);
    double ll3z_p[8], *ll3z = ll3z_p;
    int ll3z_len = expansionObject::Gen_Product_With_PreAlloc(
        l3z_len, l3z, d5_len, d5, &ll3z, 8);
    double cex_p[8], *cex = cex_p;
    int cex_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll3x_len, ll3x, pexd3_len, pexd3, &cex, 8);
    double cey_p[8], *cey = cey_p;
    int cey_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll3y_len, ll3y, peyd3_len, peyd3, &cey, 8);
    double cez_p[8], *cez = cez_p;
    int cez_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll3z_len, ll3z, pezd3_len, pezd3, &cez, 8);
    double pexd4_p[8], *pexd4 = pexd4_p;
    int pexd4_len = expansionObject::Gen_Product_With_PreAlloc(
        l5x_len, l5x, d4_len, d4, &pexd4, 8);
    double peyd4_p[8], *peyd4 = peyd4_p;
    int peyd4_len = expansionObject::Gen_Product_With_PreAlloc(
        l5y_len, l5y, d4_len, d4, &peyd4, 8);
    double pezd4_p[8], *pezd4 = pezd4_p;
    int pezd4_len = expansionObject::Gen_Product_With_PreAlloc(
        l5z_len, l5z, d4_len, d4, &pezd4, 8);
    double ll4x_p[8], *ll4x = ll4x_p;
    int ll4x_len = expansionObject::Gen_Product_With_PreAlloc(
        l4x_len, l4x, d5_len, d5, &ll4x, 8);
    double ll4y_p[8], *ll4y = ll4y_p;
    int ll4y_len = expansionObject::Gen_Product_With_PreAlloc(
        l4y_len, l4y, d5_len, d5, &ll4y, 8);
    double ll4z_p[8], *ll4z = ll4z_p;
    int ll4z_len = expansionObject::Gen_Product_With_PreAlloc(
        l4z_len, l4z, d5_len, d5, &ll4z, 8);
    double dex_p[8], *dex = dex_p;
    int dex_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll4x_len, ll4x, pexd4_len, pexd4, &dex, 8);
    double dey_p[8], *dey = dey_p;
    int dey_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll4y_len, ll4y, peyd4_len, peyd4, &dey, 8);
    double dez_p[8], *dez = dez_p;
    int dez_len = expansionObject::Gen_Diff_With_PreAlloc(
        ll4z_len, ll4z, pezd4_len, pezd4, &dez, 8);
    double aexbey_p[8], *aexbey = aexbey_p;
    int aexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, bey_len, bey, &aexbey, 8);
    double bexaey_p[8], *bexaey = bexaey_p;
    int bexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, aey_len, aey, &bexaey, 8);
    double ab_p[8], *ab = ab_p;
    int ab_len = expansionObject::Gen_Diff_With_PreAlloc(
        aexbey_len, aexbey, bexaey_len, bexaey, &ab, 8);
    double bexcey_p[8], *bexcey = bexcey_p;
    int bexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, cey_len, cey, &bexcey, 8);
    double cexbey_p[8], *cexbey = cexbey_p;
    int cexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, bey_len, bey, &cexbey, 8);
    double bc_p[8], *bc = bc_p;
    int bc_len = expansionObject::Gen_Diff_With_PreAlloc(
        bexcey_len, bexcey, cexbey_len, cexbey, &bc, 8);
    double cexdey_p[8], *cexdey = cexdey_p;
    int cexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, dey_len, dey, &cexdey, 8);
    double dexcey_p[8], *dexcey = dexcey_p;
    int dexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        dex_len, dex, cey_len, cey, &dexcey, 8);
    double cd_p[8], *cd = cd_p;
    int cd_len = expansionObject::Gen_Diff_With_PreAlloc(
        cexdey_len, cexdey, dexcey_len, dexcey, &cd, 8);
    double dexaey_p[8], *dexaey = dexaey_p;
    int dexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        dex_len, dex, aey_len, aey, &dexaey, 8);
    double aexdey_p[8], *aexdey = aexdey_p;
    int aexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, dey_len, dey, &aexdey, 8);
    double da_p[8], *da = da_p;
    int da_len = expansionObject::Gen_Diff_With_PreAlloc(
        dexaey_len, dexaey, aexdey_len, aexdey, &da, 8);
    double aexcey_p[8], *aexcey = aexcey_p;
    int aexcey_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, cey_len, cey, &aexcey, 8);
    double cexaey_p[8], *cexaey = cexaey_p;
    int cexaey_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, aey_len, aey, &cexaey, 8);
    double ac_p[8], *ac = ac_p;
    int ac_len = expansionObject::Gen_Diff_With_PreAlloc(
        aexcey_len, aexcey, cexaey_len, cexaey, &ac, 8);
    double bexdey_p[8], *bexdey = bexdey_p;
    int bexdey_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, dey_len, dey, &bexdey, 8);
    double dexbey_p[8], *dexbey = dexbey_p;
    int dexbey_len = expansionObject::Gen_Product_With_PreAlloc(
        dex_len, dex, bey_len, bey, &dexbey, 8);
    double bd_p[8], *bd = bd_p;
    int bd_len = expansionObject::Gen_Diff_With_PreAlloc(
        bexdey_len, bexdey, dexbey_len, dexbey, &bd, 8);
    double abc1_p[8], *abc1 = abc1_p;
    int abc1_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, bc_len, bc, &abc1, 8);
    double abc2_p[8], *abc2 = abc2_p;
    int abc2_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, ac_len, ac, &abc2, 8);
    double abc3_p[8], *abc3 = abc3_p;
    int abc3_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, ab_len, ab, &abc3, 8);
    double abc4_p[8], *abc4 = abc4_p;
    int abc4_len = expansionObject::Gen_Sum_With_PreAlloc(
        abc1_len, abc1, abc3_len, abc3, &abc4, 8);
    double abc_p[8], *abc = abc_p;
    int abc_len = expansionObject::Gen_Diff_With_PreAlloc(
        abc4_len, abc4, abc2_len, abc2, &abc, 8);
    double bcd1_p[8], *bcd1 = bcd1_p;
    int bcd1_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, cd_len, cd, &bcd1, 8);
    double bcd2_p[8], *bcd2 = bcd2_p;
    int bcd2_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, bd_len, bd, &bcd2, 8);
    double bcd3_p[8], *bcd3 = bcd3_p;
    int bcd3_len = expansionObject::Gen_Product_With_PreAlloc(
        dez_len, dez, bc_len, bc, &bcd3, 8);
    double bcd4_p[8], *bcd4 = bcd4_p;
    int bcd4_len = expansionObject::Gen_Sum_With_PreAlloc(
        bcd1_len, bcd1, bcd3_len, bcd3, &bcd4, 8);
    double bcd_p[8], *bcd = bcd_p;
    int bcd_len = expansionObject::Gen_Diff_With_PreAlloc(
        bcd4_len, bcd4, bcd2_len, bcd2, &bcd, 8);
    double cda1_p[8], *cda1 = cda1_p;
    int cda1_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, da_len, da, &cda1, 8);
    double cda2_p[8], *cda2 = cda2_p;
    int cda2_len = expansionObject::Gen_Product_With_PreAlloc(
        dez_len, dez, ac_len, ac, &cda2, 8);
    double cda3_p[8], *cda3 = cda3_p;
    int cda3_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, cd_len, cd, &cda3, 8);
    double cda4_p[8], *cda4 = cda4_p;
    int cda4_len = expansionObject::Gen_Sum_With_PreAlloc(
        cda1_len, cda1, cda3_len, cda3, &cda4, 8);
    double cda_p[8], *cda = cda_p;
    int cda_len = expansionObject::Gen_Sum_With_PreAlloc(
        cda4_len, cda4, cda2_len, cda2, &cda, 8);
    double dab1_p[8], *dab1 = dab1_p;
    int dab1_len = expansionObject::Gen_Product_With_PreAlloc(
        dez_len, dez, ab_len, ab, &dab1, 8);
    double dab2_p[8], *dab2 = dab2_p;
    int dab2_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, bd_len, bd, &dab2, 8);
    double dab3_p[8], *dab3 = dab3_p;
    int dab3_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, da_len, da, &dab3, 8);
    double dab4_p[8], *dab4 = dab4_p;
    int dab4_len = expansionObject::Gen_Sum_With_PreAlloc(
        dab1_len, dab1, dab3_len, dab3, &dab4, 8);
    double dab_p[8], *dab = dab_p;
    int dab_len = expansionObject::Gen_Sum_With_PreAlloc(
        dab4_len, dab4, dab2_len, dab2, &dab, 8);
    double al1_p[8], *al1 = al1_p;
    int al1_len = expansionObject::Gen_Product_With_PreAlloc(
        aex_len, aex, aex_len, aex, &al1, 8);
    double al2_p[8], *al2 = al2_p;
    int al2_len = expansionObject::Gen_Product_With_PreAlloc(
        aey_len, aey, aey_len, aey, &al2, 8);
    double al3_p[8], *al3 = al3_p;
    int al3_len = expansionObject::Gen_Product_With_PreAlloc(
        aez_len, aez, aez_len, aez, &al3, 8);
    double al4_p[8], *al4 = al4_p;
    int al4_len = expansionObject::Gen_Sum_With_PreAlloc(al1_len, al1, al2_len,
                                                         al2, &al4, 8);
    double alift_p[8], *alift = alift_p;
    int alift_len = expansionObject::Gen_Sum_With_PreAlloc(
        al4_len, al4, al3_len, al3, &alift, 8);
    double bl1_p[8], *bl1 = bl1_p;
    int bl1_len = expansionObject::Gen_Product_With_PreAlloc(
        bex_len, bex, bex_len, bex, &bl1, 8);
    double bl2_p[8], *bl2 = bl2_p;
    int bl2_len = expansionObject::Gen_Product_With_PreAlloc(
        bey_len, bey, bey_len, bey, &bl2, 8);
    double bl3_p[8], *bl3 = bl3_p;
    int bl3_len = expansionObject::Gen_Product_With_PreAlloc(
        bez_len, bez, bez_len, bez, &bl3, 8);
    double bl4_p[8], *bl4 = bl4_p;
    int bl4_len = expansionObject::Gen_Sum_With_PreAlloc(bl1_len, bl1, bl2_len,
                                                         bl2, &bl4, 8);
    double blift_p[8], *blift = blift_p;
    int blift_len = expansionObject::Gen_Sum_With_PreAlloc(
        bl4_len, bl4, bl3_len, bl3, &blift, 8);
    double cl1_p[8], *cl1 = cl1_p;
    int cl1_len = expansionObject::Gen_Product_With_PreAlloc(
        cex_len, cex, cex_len, cex, &cl1, 8);
    double cl2_p[8], *cl2 = cl2_p;
    int cl2_len = expansionObject::Gen_Product_With_PreAlloc(
        cey_len, cey, cey_len, cey, &cl2, 8);
    double cl3_p[8], *cl3 = cl3_p;
    int cl3_len = expansionObject::Gen_Product_With_PreAlloc(
        cez_len, cez, cez_len, cez, &cl3, 8);
    double cl4_p[8], *cl4 = cl4_p;
    int cl4_len = expansionObject::Gen_Sum_With_PreAlloc(cl1_len, cl1, cl2_len,
                                                         cl2, &cl4, 8);
    double clift_p[8], *clift = clift_p;
    int clift_len = expansionObject::Gen_Sum_With_PreAlloc(
        cl4_len, cl4, cl3_len, cl3, &clift, 8);
    double dl1_p[8], *dl1 = dl1_p;
    int dl1_len = expansionObject::Gen_Product_With_PreAlloc(
        dex_len, dex, dex_len, dex, &dl1, 8);
    double dl2_p[8], *dl2 = dl2_p;
    int dl2_len = expansionObject::Gen_Product_With_PreAlloc(
        dey_len, dey, dey_len, dey, &dl2, 8);
    double dl3_p[8], *dl3 = dl3_p;
    int dl3_len = expansionObject::Gen_Product_With_PreAlloc(
        dez_len, dez, dez_len, dez, &dl3, 8);
    double dl4_p[8], *dl4 = dl4_p;
    int dl4_len = expansionObject::Gen_Sum_With_PreAlloc(dl1_len, dl1, dl2_len,
                                                         dl2, &dl4, 8);
    double dlift_p[8], *dlift = dlift_p;
    int dlift_len = expansionObject::Gen_Sum_With_PreAlloc(
        dl4_len, dl4, dl3_len, dl3, &dlift, 8);
    double ds1_p[8], *ds1 = ds1_p;
    int ds1_len = expansionObject::Gen_Product_With_PreAlloc(
        dlift_len, dlift, abc_len, abc, &ds1, 8);
    double ds1n_p[8], *ds1n = ds1n_p;
    int ds1n_len = expansionObject::Gen_Product_With_PreAlloc(
        ds1_len, ds1, d3_len, d3, &ds1n, 8);
    double ds2_p[8], *ds2 = ds2_p;
    int ds2_len = expansionObject::Gen_Product_With_PreAlloc(
        clift_len, clift, dab_len, dab, &ds2, 8);
    double ds2n_p[8], *ds2n = ds2n_p;
    int ds2n_len = expansionObject::Gen_Product_With_PreAlloc(
        ds2_len, ds2, d4_len, d4, &ds2n, 8);
    double dl_p[8], *dl = dl_p;
    int dl_len = expansionObject::Gen_Diff_With_PreAlloc(
        ds2n_len, ds2n, ds1n_len, ds1n, &dl, 8);
    double dla_p[8], *dla = dla_p;
    int dla_len = expansionObject::Gen_Product_With_PreAlloc(dl_len, dl, d1_len,
                                                             d1, &dla, 8);
    double dlb_p[8], *dlb = dlb_p;
    int dlb_len = expansionObject::Gen_Product_With_PreAlloc(
        dla_len, dla, d2_len, d2, &dlb, 8);
    double dr1_p[8], *dr1 = dr1_p;
    int dr1_len = expansionObject::Gen_Product_With_PreAlloc(
        blift_len, blift, cda_len, cda, &dr1, 8);
    double dr1n_p[8], *dr1n = dr1n_p;
    int dr1n_len = expansionObject::Gen_Product_With_PreAlloc(
        dr1_len, dr1, d1_len, d1, &dr1n, 8);
    double dr2_p[8], *dr2 = dr2_p;
    int dr2_len = expansionObject::Gen_Product_With_PreAlloc(
        alift_len, alift, bcd_len, bcd, &dr2, 8);
    double dr2n_p[8], *dr2n = dr2n_p;
    int dr2n_len = expansionObject::Gen_Product_With_PreAlloc(
        dr2_len, dr2, d2_len, d2, &dr2n, 8);
    double dr_p[8], *dr = dr_p;
    int dr_len = expansionObject::Gen_Diff_With_PreAlloc(
        dr2n_len, dr2n, dr1n_len, dr1n, &dr, 8);
    double dra_p[8], *dra = dra_p;
    int dra_len = expansionObject::Gen_Product_With_PreAlloc(dr_len, dr, d3_len,
                                                             d3, &dra, 8);
    double drb_p[8], *drb = drb_p;
    int drb_len = expansionObject::Gen_Product_With_PreAlloc(
        dra_len, dra, d4_len, d4, &drb, 8);
    double det_p[8], *det = det_p;
    int det_len = expansionObject::Gen_Sum_With_PreAlloc(dlb_len, dlb, drb_len,
                                                         drb, &det, 8);
...
inline void lambda3d_LPI_exact(double px, double py, double pz, double qx,
  ...
  int ld_len = expansionObject::Gen_Sum_With_PreAlloc(tt1_len, tt1, tv9_len,
                                                      tv9, &ld, 128);
  double px_rx[2];
  ...
  int n_len = expansionObject::Gen_Diff_With_PreAlloc(tt5_len, tt5, tt2_len,
                                                      tt2, &n, 128);
  double ax_p[128], *ax = ax_p;
  int ax_len =
      expansionObject::Gen_Product_With_PreAlloc(2, a11, n_len, n, &ax, 128);
  double ay_p[128], *ay = ay_p;
  int ay_len =
      expansionObject::Gen_Product_With_PreAlloc(2, a12, n_len, n, &ay, 128);
  double az_p[128], *az = az_p;
  int az_len =
      expansionObject::Gen_Product_With_PreAlloc(2, a13, n_len, n, &az, 128);
  double dpx_p[128], *dpx = dpx_p;
  int dpx_len =
      expansionObject::Gen_Scale_With_PreAlloc(ld_len, ld, px, &dpx, 128);
  double dpy_p[128], *dpy = dpy_p;
  int dpy_len =
      expansionObject::Gen_Scale_With_PreAlloc(ld_len, ld, py, &dpy, 128);
  double dpz_p[128], *dpz = dpz_p;
  int dpz_len =
      expansionObject::Gen_Scale_With_PreAlloc(ld_len, ld, pz, &dpz, 128);
  lambda_x_len = expansionObject::Gen_Diff_With_PreAlloc(
      dpx_len, dpx, ax_len, ax, lambda_x, lambda_x_len);
  lambda_y_len = expansionObject::Gen_Diff_With_PreAlloc(
      dpy_len, dpy, ay_len, ay, lambda_y, lambda_y_len);
  lambda_z_len = expansionObject::Gen_Diff_With_PreAlloc(
      dpz_len, dpz, az_len, az, lambda_z, lambda_z_len);
  lambda_d_len = expansionObject::Gen_Sum_With_PreAlloc(
      tt1_len, tt1, tv9_len, tv9, lambda_d, lambda_d_len);
...
inline void lambda3d_TPI_exact(
  ...
  int nwyuz1_len = expansionObject::Gen_Product_With_PreAlloc(
      nwy_len, nwy, nuz_len, nuz, &nwyuz1, 16);
  double nwyuz2_p[16], *nwyuz2 = nwyuz2_p;
  int nwyuz2_len = expansionObject::Gen_Product_With_PreAlloc(
      nwz_len, nwz, nuy_len, nuy, &nwyuz2, 16);
  double nwyuz_p[16], *nwyuz = nwyuz_p;
  int nwyuz_len = expansionObject::Gen_Diff_With_PreAlloc(
      nwyuz1_len, nwyuz1, nwyuz2_len, nwyuz2, &nwyuz, 16);
  double nwxuz1_p[16], *nwxuz1 = nwxuz1_p;
  int nwxuz1_len = expansionObject::Gen_Product_With_PreAlloc(
      nwx_len, nwx, nuz_len, nuz, &nwxuz1, 16);
  double nwxuz2_p[16], *nwxuz2 = nwxuz2_p;
  int nwxuz2_len = expansionObject::Gen_Product_With_PreAlloc(
      nwz_len, nwz, nux_len, nux, &nwxuz2, 16);
  double nwxuz_p[16], *nwxuz = nwxuz_p;
  int nwxuz_len = expansionObject::Gen_Diff_With_PreAlloc(
      nwxuz1_len, nwxuz1, nwxuz2_len, nwxuz2, &nwxuz, 16);
  double nwxuy1_p[16], *nwxuy1 = nwxuy1_p;
  int nwxuy1_len = expansionObject::Gen_Product_With_PreAlloc(
      nwx_len, nwx, nuy_len, nuy, &nwxuy1, 16);
  double nwxuy2_p[16], *nwxuy2 = nwxuy2_p;
  int nwxuy2_len = expansionObject::Gen_Product_With_PreAlloc(
      nwy_len, nwy, nux_len, nux, &nwxuy2, 16);
  double nwxuy_p[16], *nwxuy = nwxuy_p;
  int nwxuy_len = expansionObject::Gen_Diff_With_PreAlloc(
      nwxuy1_len, nwxuy1, nwxuy2_len, nwxuy2, &nwxuy, 16);
  double nvyuz1_p[16], *nvyuz1 = nvyuz1_p;
  int nvyuz1_len = expansionObject::Gen_Product_With_PreAlloc(
      nvy_len, nvy, nuz_len, nuz, &nvyuz1, 16);
  double nvyuz2_p[16], *nvyuz2 = nvyuz2_p;
  int nvyuz2_len = expansionObject::Gen_Product_With_PreAlloc(
      nvz_len, nvz, nuy_len, nuy, &nvyuz2, 16);
  double nvyuz_p[16], *nvyuz = nvyuz_p;
  int nvyuz_len = expansionObject::Gen_Diff_With_PreAlloc(
      nvyuz1_len, nvyuz1, nvyuz2_len, nvyuz2, &nvyuz, 16);
  double nvxuz1_p[16], *nvxuz1 = nvxuz1_p;
  int nvxuz1_len = expansionObject::Gen_Product_With_PreAlloc(
      nvx_len, nvx, nuz_len, nuz, &nvxuz1, 16);
  double nvxuz2_p[16], *nvxuz2 = nvxuz2_p;
  int nvxuz2_len = expansionObject::Gen_Product_With_PreAlloc(
      nvz_len, nvz, nux_len, nux, &nvxuz2, 16);
  double nvxuz_p[16], *nvxuz = nvxuz_p;
  int nvxuz_len = expansionObject::Gen_Diff_With_PreAlloc(
      nvxuz1_len, nvxuz1, nvxuz2_len, nvxuz2, &nvxuz, 16);
  double nvxuy1_p[16], *nvxuy1 = nvxuy1_p;
  int nvxuy1_len = expansionObject::Gen_Product_With_PreAlloc(
      nvx_len, nvx, nuy_len, nuy, &nvxuy1, 16);
  double nvxuy2_p[16], *nvxuy2 = nvxuy2_p;
  int nvxuy2_len = expansionObject::Gen_Product_With_PreAlloc(
      nvy_len, nvy, nux_len, nux, &nvxuy2, 16);
  double nvxuy_p[16], *nvxuy = nvxuy_p;
  int nvxuy_len = expansionObject::Gen_Diff_With_PreAlloc(
      nvxuy1_len, nvxuy1, nvxuy2_len, nvxuy2, &nvxuy, 16);
  double nvywz1_p[16], *nvywz1 = nvywz1_p;
  int nvywz1_len = expansionObject::Gen_Product_With_PreAlloc(
      nvy_len, nvy, nwz_len, nwz, &nvywz1, 16);
  double nvywz2_p[16], *nvywz2 = nvywz2_p;
  int nvywz2_len = expansionObject::Gen_Product_With_PreAlloc(
      nvz_len, nvz, nwy_len, nwy, &nvywz2, 16);
  double nvywz_p[16], *nvywz = nvywz_p;
  int nvywz_len = expansionObject::Gen_Diff_With_PreAlloc(
      nvywz1_len, nvywz1, nvywz2_len, nvywz2, &nvywz, 16);
  double nvxwz1_p[16], *nvxwz1 = nvxwz1_p;
  int nvxwz1_len = expansionObject::Gen_Product_With_PreAlloc(
      nvx_len, nvx, nwz_len, nwz, &nvxwz1, 16);
  double nvxwz2_p[16], *nvxwz2 = nvxwz2_p;
  int nvxwz2_len = expansionObject::Gen_Product_With_PreAlloc(
      nvz_len, nvz, nwx_len, nwx, &nvxwz2, 16);
  double nvxwz_p[16], *nvxwz = nvxwz_p;
  int nvxwz_len = expansionObject::Gen_Diff_With_PreAlloc(
      nvxwz1_len, nvxwz1, nvxwz2_len, nvxwz2, &nvxwz, 16);
  double nvxwy1_p[16], *nvxwy1 = nvxwy1_p;
  int nvxwy1_len = expansionObject::Gen_Product_With_PreAlloc(
      nvx_len, nvx, nwy_len, nwy, &nvxwy1, 16);
  double nvxwy2_p[16], *nvxwy2 = nvxwy2_p;
  int nvxwy2_len = expansionObject::Gen_Product_With_PreAlloc(
      nvy_len, nvy, nwx_len, nwx, &nvxwy2, 16);
  double nvxwy_p[16], *nvxwy = nvxwy_p;
  int nvxwy_len = expansionObject::Gen_Diff_With_PreAlloc(
      nvxwy1_len, nvxwy1, nvxwy2_len, nvxwy2, &nvxwy, 16);
  double p1a_p[16], *p1a = p1a_p;
  int p1a_len =
      expansionObject::Gen_Scale_With_PreAlloc(nvx_len, nvx, ov1x, &p1a, 16);
  double p1b_p[16], *p1b = p1b_p;
  int p1b_len =
      expansionObject::Gen_Scale_With_PreAlloc(nvy_len, nvy, ov1y, &p1b, 16);
  double p1c_p[16], *p1c = p1c_p;
  int p1c_len =
      expansionObject::Gen_Scale_With_PreAlloc(nvz_len, nvz, ov1z, &p1c, 16);
  double p1ab_p[16], *p1ab = p1ab_p;
  int p1ab_len = expansionObject::Gen_Sum_With_PreAlloc(p1a_len, p1a, p1b_len,
                                                        p1b, &p1ab, 16);
  double p1_p[16], *p1 = p1_p;
  int p1_len = expansionObject::Gen_Sum_With_PreAlloc(p1ab_len, p1ab, p1c_len,
                                                      p1c, &p1, 16);
  double p2a_p[16], *p2a = p2a_p;
  int p2a_len =
      expansionObject::Gen_Scale_With_PreAlloc(nwx_len, nwx, ow1x, &p2a, 16);
  double p2b_p[16], *p2b = p2b_p;
  int p2b_len =
      expansionObject::Gen_Scale_With_PreAlloc(nwy_len, nwy, ow1y, &p2b, 16);
  double p2c_p[16], *p2c = p2c_p;
  int p2c_len =
      expansionObject::Gen_Scale_With_PreAlloc(nwz_len, nwz, ow1z, &p2c, 16);
  double p2ab_p[16], *p2ab = p2ab_p;
  int p2ab_len = expansionObject::Gen_Sum_With_PreAlloc(p2a_len, p2a, p2b_len,
                                                        p2b, &p2ab, 16);
  double p2_p[16], *p2 = p2_p;
  int p2_len = expansionObject::Gen_Sum_With_PreAlloc(p2ab_len, p2ab, p2c_len,
                                                      p2c, &p2, 16);
  double p3a_p[16], *p3a = p3a_p;
  int p3a_len =
      expansionObject::Gen_Scale_With_PreAlloc(nux_len, nux, ou1x, &p3a, 16);
  double p3b_p[16], *p3b = p3b_p;
  int p3b_len =
      expansionObject::Gen_Scale_With_PreAlloc(nuy_len, nuy, ou1y, &p3b, 16);
  double p3c_p[16], *p3c = p3c_p;
  int p3c_len =
      expansionObject::Gen_Scale_With_PreAlloc(nuz_len, nuz, ou1z, &p3c, 16);
  double p3ab_p[16], *p3ab = p3ab_p;
  int p3ab_len = expansionObject::Gen_Sum_With_PreAlloc(p3a_len, p3a, p3b_len,
                                                        p3b, &p3ab, 16);
  double p3_p[16], *p3 = p3_p;
  int p3_len = expansionObject::Gen_Sum_With_PreAlloc(p3ab_len, p3ab, p3c_len,
                                                      p3c, &p3, 16);
  double lxa_p[16], *lxa = lxa_p;
  int lxa_len = expansionObject::Gen_Product_With_PreAlloc(
      p1_len, p1, nwyuz_len, nwyuz, &lxa, 16);
  double lxb_p[16], *lxb = lxb_p;
  int lxb_len = expansionObject::Gen_Product_With_PreAlloc(
      p3_len, p3, nvywz_len, nvywz, &lxb, 16);
  double lxc_p[16], *lxc = lxc_p;
  int lxc_len = expansionObject::Gen_Product_With_PreAlloc(
      p2_len, p2, nvyuz_len, nvyuz, &lxc, 16);
  double lxab_p[16], *lxab = lxab_p;
  int lxab_len = expansionObject::Gen_Sum_With_PreAlloc(lxa_len, lxa, lxb_len,
                                                        lxb, &lxab, 16);
  lambda_x_len = expansionObject::Gen_Diff_With_PreAlloc(
      lxab_len, lxab, lxc_len, lxc, lambda_x, lambda_x_len);
  double lya_p[16], *lya = lya_p;
  int lya_len = expansionObject::Gen_Product_With_PreAlloc(
      p2_len, p2, nvxuz_len, nvxuz, &lya, 16);
  double lyb_p[16], *lyb = lyb_p;
  int lyb_len = expansionObject::Gen_Product_With_PreAlloc(
      p3_len, p3, nvxwz_len, nvxwz, &lyb, 16);
  double lyc_p[16], *lyc = lyc_p;
  int lyc_len = expansionObject::Gen_Product_With_PreAlloc(
      p1_len, p1, nwxuz_len, nwxuz, &lyc, 16);
  double lybc_p[16], *lybc = lybc_p;
  int lybc_len = expansionObject::Gen_Sum_With_PreAlloc(lyc_len, lyc, lyb_len,
                                                        lyb, &lybc, 16);
  lambda_y_len = expansionObject::Gen_Diff_With_PreAlloc(
      lya_len, lya, lybc_len, lybc, lambda_y, lambda_y_len);
  double lza_p[16], *lza = lza_p;
  int lza_len = expansionObject::Gen_Product_With_PreAlloc(
      p3_len, p3, nvxwy_len, nvxwy, &lza, 16);
  double lzb_p[16], *lzb = lzb_p;
  int lzb_len = expansionObject::Gen_Product_With_PreAlloc(
      p1_len, p1, nwxuy_len, nwxuy, &lzb, 16);
  double lzc_p[16], *lzc = lzc_p;
  int lzc_len = expansionObject::Gen_Product_With_PreAlloc(
      p2_len, p2, nvxuy_len, nvxuy, &lzc, 16);
  double lzab_p[16], *lzab = lzab_p;
  int lzab_len = expansionObject::Gen_Sum_With_PreAlloc(lza_len, lza, lzb_len,
                                                        lzb, &lzab, 16);
  lambda_z_len = expansionObject::Gen_Diff_With_PreAlloc(
      lzab_len, lzab, lzc_len, lzc, lambda_z, lambda_z_len);
  double da_p[16], *da = da_p;
  int da_len = expansionObject::Gen_Product_With_PreAlloc(
      nvx_len, nvx, nwyuz_len, nwyuz, &da, 16);
  double db_p[16], *db = db_p;
  int db_len = expansionObject::Gen_Product_With_PreAlloc(
      nvz_len, nvz, nwxuy_len, nwxuy, &db, 16);
  double dc_p[16], *dc = dc_p;
  int dc_len = expansionObject::Gen_Product_With_PreAlloc(
      nvy_len, nvy, nwxuz_len, nwxuz, &dc, 16);
  double dab_p[16], *dab = dab_p;
  int dab_len =
      expansionObject::Gen_Sum_With_PreAlloc(da_len, da, db_len, db, &dab, 16);
  lambda_d_len = expansionObject::Gen_Diff_With_PreAlloc(
      dab_len, dab, dc_len, dc, lambda_d, lambda_d_len);
...
inline int lessThanOnX_IE_exact(const genericPoint &p1, double bx) {
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int dbx_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, bx, &dbx, 128);
    double kx_p[128], *kx = kx_p;
    int kx_len = expansionObject::Gen_Diff_With_PreAlloc(l1x_len, l1x, dbx_len,
                                                         dbx, &kx, 128);
...
inline int lessThanOnX_II_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    int k1_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, l1x_len,
                                                            l1x, &k1, 128);
    double k2_p[128], *k2 = k2_p;
    int k2_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l2x_len,
                                                            l2x, &k2, 128);
    double kx_p[128], *kx = kx_p;
    int kx_len = expansionObject::Gen_Diff_With_PreAlloc(k1_len, k1, k2_len, k2,
                                                         &kx, 128);
...
inline int lessThanOnY_IE_exact(const genericPoint &p1, double by) {
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int dby_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, by, &dby, 128);
    double ky_p[128], *ky = ky_p;
    int ky_len = expansionObject::Gen_Diff_With_PreAlloc(l1y_len, l1y, dby_len,
                                                         dby, &ky, 128);
...
inline int lessThanOnY_II_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    double k1_p[128], *k1 = k1_p;
    int k1_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, l1y_len,
                                                            l1y, &k1, 128);
    double k2_p[128], *k2 = k2_p;
    int k2_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l2y_len,
                                                            l2y, &k2, 128);
    double ky_p[128], *ky = ky_p;
    int ky_len = expansionObject::Gen_Diff_With_PreAlloc(k1_len, k1, k2_len, k2,
                                                         &ky, 128);
...
inline int lessThanOnZ_IE_exact(const genericPoint &p1, double bz) {
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int dbz_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, bz, &dbz, 128);
    double kz_p[128], *kz = kz_p;
    int kz_len = expansionObject::Gen_Diff_With_PreAlloc(l1z_len, l1z, dbz_len,
                                                         dbz, &kz, 128);
...
inline int lessThanOnZ_II_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    double k1_p[128], *k1 = k1_p;
    int k1_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, l1z_len,
                                                            l1z, &k1, 128);
    double k2_p[128], *k2 = k2_p;
    int k2_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l2z_len,
                                                            l2z, &k2, 128);
    double kz_p[128], *kz = kz_p;
    int kz_len = expansionObject::Gen_Diff_With_PreAlloc(k1_len, k1, k2_len, k2,
                                                         &kz, 128);
...
inline int orient2dxy_indirect_IEE_exact(const genericPoint &p1, double p2x,
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int e2_len = expansionObject::Gen_Product_With_PreAlloc(l1x_len, l1x, 2,
                                                            t1x, &e2, 128);
    double e3_p[128], *e3 = e3_p;
    int e3_len = expansionObject::Gen_Product_With_PreAlloc(l1y_len, l1y, 2,
                                                            t1y, &e3, 128);
    double e_p[128], *e = e_p;
    int e_len =
        expansionObject::Gen_Sum_With_PreAlloc(e2_len, e2, e3_len, e3, &e, 128);
    double pr1[2];
    ...
    int dpr_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, 4, pr,
                                                             &dpr, 128);
    double det_p[128], *det = det_p;
    int det_len = expansionObject::Gen_Sum_With_PreAlloc(dpr_len, dpr, e_len, e,
                                                         &det, 128);
...
inline int orient2dxy_indirect_IIE_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    double a_p[64], *a = a_p;
    int a_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l2x_len,
                                                           l2x, &a, 64);
    double b_p[64], *b = b_p;
    int b_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, l1x_len,
                                                           l1x, &b, 64);
    double c_p[64], *c = c_p;
    int c_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, op3y, &c, 64);
    double e_p[64], *e = e_p;
    int e_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l2y_len,
                                                           l2y, &e, 64);
    double f_p[64], *f = f_p;
    int f_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, l1y_len,
                                                           l1y, &f, 64);
    double g_p[64], *g = g_p;
    int g_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, op3x, &g, 64);
    double ab_p[64], *ab = ab_p;
    int ab_len =
        expansionObject::Gen_Diff_With_PreAlloc(a_len, a, b_len, b, &ab, 64);
    double cd_p[64], *cd = cd_p;
    int cd_len = expansionObject::Gen_Diff_With_PreAlloc(c_len, c, l1y_len, l1y,
                                                         &cd, 64);
    double ef_p[64], *ef = ef_p;
    int ef_len =
        expansionObject::Gen_Diff_With_PreAlloc(e_len, e, f_len, f, &ef, 64);
    double gh_p[64], *gh = gh_p;
    int gh_len = expansionObject::Gen_Diff_With_PreAlloc(g_len, g, l1x_len, l1x,
                                                         &gh, 64);
    double abcd_p[64], *abcd = abcd_p;
    int abcd_len = expansionObject::Gen_Product_With_PreAlloc(
        ab_len, ab, cd_len, cd, &abcd, 64);
    double efgh_p[64], *efgh = efgh_p;
    int efgh_len = expansionObject::Gen_Product_With_PreAlloc(
        ef_len, ef, gh_len, gh, &efgh, 64);
    double L_p[64], *L = L_p;
    int L_len = expansionObject::Gen_Diff_With_PreAlloc(abcd_len, abcd,
                                                        efgh_len, efgh, &L, 64);
...
inline int orient2dxy_indirect_III_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0)) {
    ...
    int b_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, l1x_len,
                                                           l1x, &b, 64);
    double c_p[64], *c = c_p;
    int c_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l3y_len,
                                                           l3y, &c, 64);
    double d_p[64], *d = d_p;
    int d_len = expansionObject::Gen_Product_With_PreAlloc(d3_len, d3, l1y_len,
                                                           l1y, &d, 64);
    double e_p[64], *e = e_p;
    int e_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l2y_len,
                                                           l2y, &e, 64);
    ...
    int f_len = expansionObject::Gen_Product_With_PreAlloc(d2_len, d2, l1y_len,
                                                           l1y, &f, 64);
    double g_p[64], *g = g_p;
    int g_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l3x_len,
                                                           l3x, &g, 64);
    double h_p[64], *h = h_p;
    int h_len = expansionObject::Gen_Product_With_PreAlloc(d3_len, d3, l1x_len,
                                                           l1x, &h, 64);
    double ab_p[64], *ab = ab_p;
    int ab_len =
        expansionObject::Gen_Diff_With_PreAlloc(a_len, a, b_len, b, &ab, 64);
    double cd_p[64], *cd = cd_p;
    int cd_len =
        expansionObject::Gen_Diff_With_PreAlloc(c_len, c, d_len, d, &cd, 64);
    double ef_p[64], *ef = ef_p;
    int ef_len =
        expansionObject::Gen_Diff_With_PreAlloc(e_len, e, f_len, f, &ef, 64);
    double gh_p[64], *gh = gh_p;
    int gh_len =
        expansionObject::Gen_Diff_With_PreAlloc(g_len, g, h_len, h, &gh, 64);
    double abcd_p[64], *abcd = abcd_p;
    int abcd_len = expansionObject::Gen_Product_With_PreAlloc(
        ab_len, ab, cd_len, cd, &abcd, 64);
    double efgh_p[64], *efgh = efgh_p;
...
inline int orient2d_indirect_IIE_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    double c_p[64], *c = c_p;
    int c_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, p3y, &c, 64);
    double e_p[64], *e = e_p;
    int e_len = expansionObject::Gen_Product_With_PreAlloc(d1_len, d1, l2y_len,
                                                           l2y, &e, 64);
    double f_p[64], *f = f_p;
    ...
    double g_p[64], *g = g_p;
    int g_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, p3x, &g, 64);
    double ab_p[64], *ab = ab_p;
    int ab_len =
        expansionObject::Gen_Diff_With_PreAlloc(a_len, a, b_len, b, &ab, 64);
    double cd_p[64], *cd = cd_p;
...
inline int orient3d_indirect_IEEE_exact(const genericPoint &p1, double ax,
  ...
  if ((d1[d1_len - 1] != 0)) {
    ...
    int dcx_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, cx, &dcx, 64);
    double dcy_p[64], *dcy = dcy_p;
    int dcy_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, cy, &dcy, 64);
    double dcz_p[64], *dcz = dcz_p;
    int dcz_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, cz, &dcz, 64);
    double ix_cx_p[64], *ix_cx = ix_cx_p;
    int ix_cx_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1x_len, l1x, dcx_len, dcx, &ix_cx, 64);
    double iy_cy_p[64], *iy_cy = iy_cy_p;
    int iy_cy_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1y_len, l1y, dcy_len, dcy, &iy_cy, 64);
    double ax_cx[2];
    ...
    int iz_cz_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1z_len, l1z, dcz_len, dcz, &iz_cz, 64);
    double bx_cx[2];
    ...
    int tmc_a_len = expansionObject::Gen_Product_With_PreAlloc(
        ix_cx_len, ix_cx, 2, ay_cy, &tmc_a, 64);
    double tmc_b_p[64], *tmc_b = tmc_b_p;
    int tmc_b_len = expansionObject::Gen_Product_With_PreAlloc(
        iy_cy_len, iy_cy, 2, ax_cx, &tmc_b, 64);
    double m01_p[64], *m01 = m01_p;
    int m01_len = expansionObject::Gen_Diff_With_PreAlloc(
        tmc_a_len, tmc_a, tmc_b_len, tmc_b, &m01, 64);
    double tmi_a_p[64], *tmi_a = tmi_a_p;
    int tmi_a_len = expansionObject::Gen_Product_With_PreAlloc(
        ix_cx_len, ix_cx, 2, az_cz, &tmi_a, 64);
    double tmi_b_p[64], *tmi_b = tmi_b_p;
    int tmi_b_len = expansionObject::Gen_Product_With_PreAlloc(
        iz_cz_len, iz_cz, 2, ax_cx, &tmi_b, 64);
    double m02_p[64], *m02 = m02_p;
    int m02_len = expansionObject::Gen_Diff_With_PreAlloc(
        tmi_a_len, tmi_a, tmi_b_len, tmi_b, &m02, 64);
    double tma_a_p[64], *tma_a = tma_a_p;
    int tma_a_len = expansionObject::Gen_Product_With_PreAlloc(
        iy_cy_len, iy_cy, 2, az_cz, &tma_a, 64);
    double tma_b_p[64], *tma_b = tma_b_p;
    int tma_b_len = expansionObject::Gen_Product_With_PreAlloc(
        iz_cz_len, iz_cz, 2, ay_cy, &tma_b, 64);
    double m12_p[64], *m12 = m12_p;
    int m12_len = expansionObject::Gen_Diff_With_PreAlloc(
        tma_a_len, tma_a, tma_b_len, tma_b, &m12, 64);
    double mt1_p[64], *mt1 = mt1_p;
    int mt1_len = expansionObject::Gen_Product_With_PreAlloc(m01_len, m01, 2,
                                                             bz_cz, &mt1, 64);
    double mt2_p[64], *mt2 = mt2_p;
    int mt2_len = expansionObject::Gen_Product_With_PreAlloc(m02_len, m02, 2,
                                                             by_cy, &mt2, 64);
    double mt3_p[64], *mt3 = mt3_p;
    int mt3_len = expansionObject::Gen_Product_With_PreAlloc(m12_len, m12, 2,
                                                             bx_cx, &mt3, 64);
    double mtt_p[64], *mtt = mtt_p;
    int mtt_len = expansionObject::Gen_Diff_With_PreAlloc(mt2_len, mt2, mt1_len,
                                                          mt1, &mtt, 64);
    double m012_p[64], *m012 = m012_p;
    int m012_len = expansionObject::Gen_Diff_With_PreAlloc(
        mtt_len, mtt, mt3_len, mt3, &m012, 64);
...
inline int orient3d_indirect_IIEE_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0)) {
    ...
    int d1p4x_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, p4x, &d1p4x, 32);
    double d1p4y_p[32], *d1p4y = d1p4y_p;
    int d1p4y_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, p4y, &d1p4y, 32);
    double d1p4z_p[32], *d1p4z = d1p4z_p;
    int d1p4z_len =
        expansionObject::Gen_Scale_With_PreAlloc(d1_len, d1, p4z, &d1p4z, 32);
    double d2p4x_p[32], *d2p4x = d2p4x_p;
    int d2p4x_len =
        expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, p4x, &d2p4x, 32);
    double d2p4y_p[32], *d2p4y = d2p4y_p;
    int d2p4y_len =
        expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, p4y, &d2p4y, 32);
    double d2p4z_p[32], *d2p4z = d2p4z_p;
    int d2p4z_len =
        expansionObject::Gen_Scale_With_PreAlloc(d2_len, d2, p4z, &d2p4z, 32);
    double p1p4x_p[32], *p1p4x = p1p4x_p;
    int p1p4x_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1x_len, l1x, d1p4x_len, d1p4x, &p1p4x, 32);
    double p1p4y_p[32], *p1p4y = p1p4y_p;
    int p1p4y_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1y_len, l1y, d1p4y_len, d1p4y, &p1p4y, 32);
    double p1p4z_p[32], *p1p4z = p1p4z_p;
    int p1p4z_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1z_len, l1z, d1p4z_len, d1p4z, &p1p4z, 32);
    double p2p4x_p[32], *p2p4x = p2p4x_p;
    int p2p4x_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2x_len, l2x, d2p4x_len, d2p4x, &p2p4x, 32);
    double p2p4y_p[32], *p2p4y = p2p4y_p;
    int p2p4y_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2y_len, l2y, d2p4y_len, d2p4y, &p2p4y, 32);
    double p2p4z_p[32], *p2p4z = p2p4z_p;
    int p2p4z_len = expansionObject::Gen_Diff_With_PreAlloc(
        l2z_len, l2z, d2p4z_len, d2p4z, &p2p4z, 32);
    double p3p4x[2];
    ...
    int tmc_a_len = expansionObject::Gen_Product_With_PreAlloc(
        p1p4x_len, p1p4x, p2p4y_len, p2p4y, &tmc_a, 32);
    double tmc_b_p[32], *tmc_b = tmc_b_p;
    int tmc_b_len = expansionObject::Gen_Product_With_PreAlloc(
        p1p4y_len, p1p4y, p2p4x_len, p2p4x, &tmc_b, 32);
    double m01_p[32], *m01 = m01_p;
    int m01_len = expansionObject::Gen_Diff_With_PreAlloc(
        tmc_a_len, tmc_a, tmc_b_len, tmc_b, &m01, 32);
    double tmi_a_p[32], *tmi_a = tmi_a_p;
    int tmi_a_len = expansionObject::Gen_Product_With_PreAlloc(
        p1p4x_len, p1p4x, p2p4z_len, p2p4z, &tmi_a, 32);
    double tmi_b_p[32], *tmi_b = tmi_b_p;
    int tmi_b_len = expansionObject::Gen_Product_With_PreAlloc(
        p1p4z_len, p1p4z, p2p4x_len, p2p4x, &tmi_b, 32);
    double m02_p[32], *m02 = m02_p;
    int m02_len = expansionObject::Gen_Diff_With_PreAlloc(
        tmi_a_len, tmi_a, tmi_b_len, tmi_b, &m02, 32);
    double tma_a_p[32], *tma_a = tma_a_p;
    int tma_a_len = expansionObject::Gen_Product_With_PreAlloc(
        p1p4y_len, p1p4y, p2p4z_len, p2p4z, &tma_a, 32);
    double tma_b_p[32], *tma_b = tma_b_p;
    int tma_b_len = expansionObject::Gen_Product_With_PreAlloc(
        p1p4z_len, p1p4z, p2p4y_len, p2p4y, &tma_b, 32);
    double m12_p[32], *m12 = m12_p;
    int m12_len = expansionObject::Gen_Diff_With_PreAlloc(
        tma_a_len, tma_a, tma_b_len, tma_b, &m12, 32);
    ...
    int m012_len = expansionObject::Gen_Diff_With_PreAlloc(
        mtt_len, mtt, mt3_len, mt3, &m012, 32);
...
inline int orient3d_indirect_IIIE_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0)) {
    ...
    int d3p4x_len =
        expansionObject::Gen_Scale_With_PreAlloc(d3_len, d3, p4x, &d3p4x, 32);
    double d3p4y_p[32], *d3p4y = d3p4y_p;
    int d3p4y_len =
        expansionObject::Gen_Scale_With_PreAlloc(d3_len, d3, p4y, &d3p4y, 32);
    double d3p4z_p[32], *d3p4z = d3p4z_p;
    int d3p4z_len =
        expansionObject::Gen_Scale_With_PreAlloc(d3_len, d3, p4z, &d3p4z, 32);
    double p1p4x_p[32], *p1p4x = p1p4x_p;
    int p1p4x_len = expansionObject::Gen_Diff_With_PreAlloc(
        l1x_len, l1x, d1p4x_len, d1p4x, &p1p4x, 32);
    double p1p4y_p[32], *p1p4y = p1p4y_p;
    ...
    int p3p4x_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3x_len, l3x, d3p4x_len, d3p4x, &p3p4x, 32);
    double p3p4y_p[32], *p3p4y = p3p4y_p;
    int p3p4y_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3y_len, l3y, d3p4y_len, d3p4y, &p3p4y, 32);
    double p3p4z_p[32], *p3p4z = p3p4z_p;
    int p3p4z_len = expansionObject::Gen_Diff_With_PreAlloc(
        l3z_len, l3z, d3p4z_len, d3p4z, &p3p4z, 32);
    double tmc_a_p[32], *tmc_a = tmc_a_p;
    int tmc_a_len = expansionObject::Gen_Product_With_PreAlloc(
        p1p4x_len, p1p4x, p2p4y_len, p2p4y, &tmc_a, 32);
    double tmc_b_p[32], *tmc_b = tmc_b_p;
    ...
    int m12_len = expansionObject::Gen_Diff_With_PreAlloc(
        tma_a_len, tma_a, tma_b_len, tma_b, &m12, 32);
    double mt1_p[32], *mt1 = mt1_p;
    int mt1_len = expansionObject::Gen_Product_With_PreAlloc(
        m01_len, m01, p3p4z_len, p3p4z, &mt1, 32);
    double mt2_p[32], *mt2 = mt2_p;
    int mt2_len = expansionObject::Gen_Product_With_PreAlloc(
        m02_len, m02, p3p4y_len, p3p4y, &mt2, 32);
    double mt3_p[32], *mt3 = mt3_p;
    int mt3_len = expansionObject::Gen_Product_With_PreAlloc(
        m12_len, m12, p3p4x_len, p3p4x, &mt3, 32);
    double mtt_p[32], *mtt = mtt_p;
    int mtt_len = expansionObject::Gen_Diff_With_PreAlloc(mt2_len, mt2, mt1_len,
                                                          mt1, &mtt, 32);
    double m012_p[32], *m012 = m012_p;
...
inline int orient3d_indirect_IIII_exact(const genericPoint &p1,
  ...
  if ((d1[d1_len - 1] != 0) && (d2[d2_len - 1] != 0) && (d3[d3_len - 1] != 0) &&
    ...
    double d1p4x_p[32], *d1p4x = d1p4x_p;
    int d1p4x_len = expansionObject::Gen_Product_With_PreAlloc(
        d1_len, d1, l4x_len, l4x, &d1p4x, 32);
    double d1p4y_p[32], *d1p4y = d1p4y_p;
    int d1p4y_len = expansionObject::Gen_Product_With_PreAlloc(
        d1_len, d1, l4y_len, l4y, &d1p4y, 32);
    double d1p4z_p[32], *d1p4z = d1p4z_p;
    int d1p4z_len = expansionObject::Gen_Product_With_PreAlloc(
        d1_len, d1, l4z_len, l4z, &d1p4z, 32);
    double d2p4x_p[32], *d2p4x = d2p4x_p;
    int d2p4x_len = expansionObject::Gen_Product_With_PreAlloc(
        d2_len, d2, l4x_len, l4x, &d2p4x, 32);
    double d2p4y_p[32], *d2p4y = d2p4y_p;
    int d2p4y_len = expansionObject::Gen_Product_With_PreAlloc(
        d2_len, d2, l4y_len, l4y, &d2p4y, 32);
    double d2p4z_p[32], *d2p4z = d2p4z_p;
    int d2p4z_len = expansionObject::Gen_Product_With_PreAlloc(
        d2_len, d2, l4z_len, l4z, &d2p4z, 32);
    double d3p4x_p[32], *d3p4x = d3p4x_p;
    int d3p4x_len = expansionObject::Gen_Product_With_PreAlloc(
        d3_len, d3, l4x_len, l4x, &d3p4x, 32);
    double d3p4y_p[32], *d3p4y = d3p4y_p;
    int d3p4y_len = expansionObject::Gen_Product_With_PreAlloc(
        d3_len, d3, l4y_len, l4y, &d3p4y, 32);
    double d3p4z_p[32], *d3p4z = d3p4z_p;
    int d3p4z_len = expansionObject::Gen_Product_With_PreAlloc(
        d3_len, d3, l4z_len, l4z, &d3p4z, 32);
    double d4l1x_p[32], *d4l1x = d4l1x_p;
    int d4l1x_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l1x_len, l1x, &d4l1x, 32);
    double d4l1y_p[32], *d4l1y = d4l1y_p;
    int d4l1y_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l1y_len, l1y, &d4l1y, 32);
    double d4l1z_p[32], *d4l1z = d4l1z_p;
    int d4l1z_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l1z_len, l1z, &d4l1z, 32);
    double d4l2x_p[32], *d4l2x = d4l2x_p;
    int d4l2x_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l2x_len, l2x, &d4l2x, 32);
    double d4l2y_p[32], *d4l2y = d4l2y_p;
    int d4l2y_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l2y_len, l2y, &d4l2y, 32);
    double d4l2z_p[32], *d4l2z = d4l2z_p;
    int d4l2z_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l2z_len, l2z, &d4l2z, 32);
    double d4l3x_p[32], *d4l3x = d4l3x_p;
    int d4l3x_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l3x_len, l3x, &d4l3x, 32);
    double d4l3y_p[32], *d4l3y = d4l3y_p;
    int d4l3y_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l3y_len, l3y, &d4l3y, 32);
    double d4l3z_p[32], *d4l3z = d4l3z_p;
    int d4l3z_len = expansionObject::Gen_Product_With_PreAlloc(
        d4_len, d4, l3z_len, l3z, &d4l3z, 32);
    double p1p4x_p[32], *p1p4x = p1p4x_p;
    int p1p4x_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l1x_len, d4l1x, d1p4x_len, d1p4x, &p1p4x, 32);
    double p1p4y_p[32], *p1p4y = p1p4y_p;
    int p1p4y_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l1y_len, d4l1y, d1p4y_len, d1p4y, &p1p4y, 32);
    double p1p4z_p[32], *p1p4z = p1p4z_p;
    int p1p4z_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l1z_len, d4l1z, d1p4z_len, d1p4z, &p1p4z, 32);
    double p2p4x_p[32], *p2p4x = p2p4x_p;
    int p2p4x_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l2x_len, d4l2x, d2p4x_len, d2p4x, &p2p4x, 32);
    double p2p4y_p[32], *p2p4y = p2p4y_p;
    int p2p4y_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l2y_len, d4l2y, d2p4y_len, d2p4y, &p2p4y, 32);
    double p2p4z_p[32], *p2p4z = p2p4z_p;
    int p2p4z_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l2z_len, d4l2z, d2p4z_len, d2p4z, &p2p4z, 32);
    double p3p4x_p[32], *p3p4x = p3p4x_p;
    int p3p4x_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l3x_len, d4l3x, d3p4x_len, d3p4x, &p3p4x, 32);
    double p3p4y_p[32], *p3p4y = p3p4y_p;
    int p3p4y_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l3y_len, d4l3y, d3p4y_len, d3p4y, &p3p4y, 32);
    double p3p4z_p[32], *p3p4z = p3p4z_p;
    int p3p4z_len = expansionObject::Gen_Diff_With_PreAlloc(
        d4l3z_len, d4l3z, d3p4z_len, d3p4z, &p3p4z, 32);
    double tmc_a_p[32], *tmc_a = tmc_a_p;
    int tmc_a_len = expansionObject::Gen_Product_With_PreAlloc(
        p1p4x_len, p1p4x, p2p4y_len, p2p4y, &tmc_a, 32);
    double tmc_b_p[32], *tmc_b = tmc_b_p;
